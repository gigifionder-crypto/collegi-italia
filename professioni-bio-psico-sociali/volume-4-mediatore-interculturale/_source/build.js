...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(path.join(__dirname, "volume-4-mediatore-interculturale.docx"), buf);
  console.log("Written volume-4-mediatore-interculturale.docx", buf.length, "bytes");
});
