...
<div class="cover">
  ...
  <p class="sub" style="font-size:11pt;color:#555;">L'opera integrale «Una guerra senza fine» — quindici Libri e quattro Appendici</p>
  <div class="rule"></div>
  <p class="imp">Il ritratto · Dal Che a Moro · la parabola di Guevara · il Dossier maggiore · il vettore e il ceppo · il filo del 1926<br>le questioni aperte · il metodo · il registro giudiziario · il repertorio · le responsabilità personali<br>la dimensione diplomatica · il fascicolo aperto con la quadriga investigativa<br>(il programma · il manuale in 400 blocchi · l'agenda in 300 · i nove cantieri in 1.000)<br>e la triangolazione di un solo nome col corpus in 1.000 blocchi: Il codice e la sua trasmissione<br><br>Edizione integrale in senso stretto: nessun documento del corpus moroteano resta fuori<br>Quinta edizione — 27 agosto 2026<br><span style="font-size:8.4pt">La quarta è del 26 agosto e portava quattordici Libri e due Appendici: non è ritirata, è superata. Resta fuori, per dichiarazione, l'opera «Italia Nera», che è un lavoro distinto e non una parte di questo.</span></p>
