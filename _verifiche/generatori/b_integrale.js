...
const parts=[
 ...
 {title:'Libro sedicesimo — Le tavole della custodia — I. Il fascicolo: vita, prigionia, mandanti, esecutori, e l\'ipotesi del trasferimento', file:'il-fascicolo-della-custodia.md'},
 {title:'Libro sedicesimo — Le tavole della custodia — II. La matrice della custodia', file:'la-matrice-della-custodia.md'},
 {title:'Libro sedicesimo — Le tavole della custodia — III. Il quesito della sabbia', file:'il-quesito-della-sabbia.md'},
 {title:'Libro sedicesimo — Le tavole della custodia — IV. La matrice di via Fani', file:'la-matrice-di-via-fani.md'},
 {title:'Libro sedicesimo — Le tavole della custodia — V. La matrice delle omissioni', file:'la-matrice-delle-omissioni.md'},
