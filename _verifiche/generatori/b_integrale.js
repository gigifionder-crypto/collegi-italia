...
**L'opera integrale «Una guerra senza fine» — il corpus storico completo del branch, in quindici Libri e cinque Appendici**
...
const parts=[
 ...
 {title:'Libro nono · II — Appendice quinta alla Fase settima', file:'appendici-fase-settima/appendice-quinta-fase-settima.md'},
 {title:'Libro nono · III — Appendice sesta alla Fase settima', file:'appendici-fase-settima/appendice-sesta-fase-settima.md'},
 {title:'Libro nono · IV — Appendice settima alla Fase settima', file:'appendici-fase-settima/appendice-settima-fase-settima.md'},
 {title:'Libro nono · V — Appendice ottava alla Fase settima', file:'appendici-fase-settima/appendice-ottava-fase-settima.md'},
 {title:'Libro nono · VI — Appendice nona alla Fase settima', file:'appendici-fase-settima/appendice-nona-fase-settima.md'},
 {title:'Libro nono · VII — Appendice decima alla Fase settima', file:'appendici-fase-settima/appendice-decima-fase-settima.md'},
 {title:'Libro nono · VIII — Appendice undicesima alla Fase settima', file:'appendici-fase-settima/appendice-undicesima-fase-settima.md'},
 {title:'Libro nono · IX — Appendice dodicesima alla Fase settima', file:'appendici-fase-settima/appendice-dodicesima-fase-settima.md'},
 {title:'Libro nono · X — Appendice tredicesima alla Fase settima', file:'appendici-fase-settima/appendice-tredicesima-fase-settima.md'},
 {title:'Libro nono · XI — Appendice quattordicesima alla Fase settima', file:'appendici-fase-settima/appendice-quattordicesima-fase-settima.md'},
 {title:'Libro nono · XII — Appendice quindicesima alla Fase settima', file:'appendici-fase-settima/appendice-quindicesima-fase-settima.md'},
 ...
 {title:'Libro dodicesimo · IV — Aldo Moro Alla Farnesina E L\'Opus Dei', file:'moro-ministro-esteri/terza-campagna/terza-ricognizione-spagna-opus-dei.md'},
 {title:'Libro dodicesimo · V — Aldo Moro Alla Farnesina E Il Portogallo', file:'moro-ministro-esteri/terza-campagna/quarta-ricognizione-portogallo-santa-sede.md'},
 {title:'Libro dodicesimo · VI — Aldo Moro Alla Farnesina, Il Portogallo E La Santa Sede', file:'moro-ministro-esteri/terza-campagna/quinta-ricognizione-portogallo-le-sei-lacune.md'},
 {title:'Libro dodicesimo · VII — Aldo Moro Alla Farnesina, Il Portogallo E L\'Opus Dei', file:'moro-ministro-esteri/terza-campagna/sesta-ricognizione-il-ribaltamento-iberico.md'},
 {title:'Libro dodicesimo · VIII — Aldo Moro Alla Farnesina, La Turchia E La Santa Sede', file:'moro-ministro-esteri/terza-campagna/settima-ricognizione-turchia-e-attentato.md'},
 {title:'Libro dodicesimo · IX — Moro, Il Mediterraneo Orientale E L\'Opus Dei', file:'moro-ministro-esteri/terza-campagna/ottava-ricognizione-mediterraneo-orientale.md'},
 {title:'Libro dodicesimo · X — Moro, Le Due Germanie E La Santa Sede', file:'moro-ministro-esteri/terza-campagna/nona-ricognizione-la-sequenza-oder-neisse.md'},
 {title:'Libro dodicesimo · XI — Moro, La Germania E L\'Opus Dei', file:'moro-ministro-esteri/terza-campagna/decima-ricognizione-revisione-del-modello.md'},
 {title:'Libro dodicesimo · XII — Strauss E Aginter Press', file:'moro-ministro-esteri/terza-campagna/undicesima-ricognizione-strauss-e-aginter.md'},
 {title:'Libro dodicesimo · XIII — I Sette Casi Extraeuropei', file:'moro-ministro-esteri/terza-campagna/dodicesima-ricognizione-sette-casi-extraeuropei.md'},
 {title:'Libro dodicesimo · XIV — Aginter Press E Lo Stato Italiano', file:'moro-ministro-esteri/terza-campagna/tredicesima-ricognizione-aginter-i-due-silenzi.md'},
 {title:'Libro dodicesimo · XV — Il Silenzio Dello Stato: Azione O Archivio', file:'moro-ministro-esteri/terza-campagna/quattordicesima-ricognizione-la-calibrazione-libica.md'},
 {title:'Libro dodicesimo · XVI — L\'Italia, L\'Aermacchi E Il Sudafrica Dell\'Apartheid', file:'moro-ministro-esteri/terza-campagna/quindicesima-ricognizione-aermacchi-e-il-sudafrica.md'},
 {title:'Libro dodicesimo · XVII — Italia E Germania Sul Dossier Namibiano', file:'moro-ministro-esteri/terza-campagna/sedicesima-ricognizione-il-dossier-namibiano.md'},
 {title:'Libro dodicesimo · XVIII — La Santa Sede, La Dc E Il Sudafrica Dell\'Apartheid', file:'moro-ministro-esteri/terza-campagna/diciassettesima-ricognizione-santa-sede-e-sudafrica.md'},
 {title:'Libro dodicesimo · XIX — L\'Italia Alle Nazioni Unite: Embargo, Apartheid, Namibia', file:'moro-ministro-esteri/terza-campagna/diciottesima-ricognizione-nazioni-unite-ed-embargo.md'},
 {title:'Libro dodicesimo · XX — Registro Analitico Dei Nodi E Dei Ponti', file:'moro-ministro-esteri/terza-campagna/registro-dei-nodi-e-dei-ponti-teatro-australe.md'},
 {title:'Libro dodicesimo · XXI — Secondo Registro Analitico Dei Nodi E Dei Ponti', file:'moro-ministro-esteri/terza-campagna/secondo-registro-dei-nodi-e-dei-ponti.md'},
 {title:'Libro dodicesimo · XXII — Terzo Registro Analitico Dei Nodi E Dei Ponti', file:'moro-ministro-esteri/terza-campagna/terzo-registro-dei-nodi-e-dei-ponti.md'},
 {title:'Libro dodicesimo · XXIII — Quarto Registro Analitico', file:'moro-ministro-esteri/terza-campagna/quarto-registro-la-scala-degli-stati-zero.md'},
 {title:'Libro dodicesimo · XXIV — Quinto Registro Analitico', file:'moro-ministro-esteri/terza-campagna/quinto-registro-la-tavola-unica.md'},
 {title:'Libro dodicesimo · XXV — Sesto Registro Analitico', file:'moro-ministro-esteri/terza-campagna/sesto-registro-strumenti-e-volume.md'},
 {title:'Libro dodicesimo · XXVI — Settimo Registro Analitico', file:'moro-ministro-esteri/terza-campagna/settimo-registro-la-riqualificazione.md'},
 {title:'Libro dodicesimo · XXVII — Registro Delle Undici Ricognizioni', file:'moro-ministro-esteri/terza-campagna/registro-delle-undici-ricognizioni.md'},
 {title:'Libro dodicesimo · XXVIII — La triangolazione della terza campagna', file:'moro-ministro-esteri/triangolazione-terza-campagna.md'},
 ...
 {title:'Libro quindicesimo — Il Registro dei cinquantacinque giorni, opera seconda', file:'il-registro-dei-cinquantacinque-giorni-opera-seconda.md'},
