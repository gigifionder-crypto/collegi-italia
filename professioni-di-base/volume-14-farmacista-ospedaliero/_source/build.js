...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(path.join(__dirname, "volume-14-farmacista-ospedaliero.docx"), buf);
  console.log("Written volume-14-farmacista-ospedaliero.docx", buf.length, "bytes");
});
