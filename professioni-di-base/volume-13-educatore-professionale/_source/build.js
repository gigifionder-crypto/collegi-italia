...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(path.join(__dirname, "volume-13-educatore-professionale.docx"), buf);
  console.log("Written volume-13-educatore-professionale.docx", buf.length, "bytes");
});
