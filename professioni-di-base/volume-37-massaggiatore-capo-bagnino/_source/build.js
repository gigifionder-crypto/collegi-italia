...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(path.join(__dirname, "volume-37-massaggiatore-capo-bagnino.docx"), buf);
  console.log("Written volume-37-massaggiatore-capo-bagnino.docx", buf.length, "bytes");
});
