...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(path.join(__dirname, "volume-16-infermiere-pediatrico.docx"), buf);
  console.log("Written volume-16-infermiere-pediatrico.docx", buf.length, "bytes");
});
