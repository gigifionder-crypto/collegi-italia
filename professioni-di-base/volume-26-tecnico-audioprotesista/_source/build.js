...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(path.join(__dirname, "volume-26-tecnico-audioprotesista.docx"), buf);
  console.log("Written volume-26-tecnico-audioprotesista.docx", buf.length, "bytes");
});
