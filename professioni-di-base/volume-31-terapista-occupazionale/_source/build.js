...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(path.join(__dirname, "volume-31-terapista-occupazionale.docx"), buf);
  console.log("Written volume-31-terapista-occupazionale.docx", buf.length, "bytes");
});
