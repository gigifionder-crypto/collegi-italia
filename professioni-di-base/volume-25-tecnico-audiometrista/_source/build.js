...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync(path.join(__dirname, "volume-25-tecnico-audiometrista.docx"), buf);
  console.log("Written volume-25-tecnico-audiometrista.docx", buf.length, "bytes");
});
