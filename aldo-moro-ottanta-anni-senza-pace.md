...
> del repository. È la forma narrativa di un corpus documentale di oltre otto
> milioni di parole, e **ne conserva integralmente la disciplina**: ogni
> affermazione porta il suo grado di prova — **A** giudicato definitivo, **B**
> accertamento qualificato, **C** congettura o fonte secondaria, **F** fatto
> pubblico, **Stato Zero** assenza documentata con sede nominata e
> interrogata. Nessuna persona è indicata come responsabile di un reato fuori
...
**Sul nome.** *Opera Nera* è il nome che quest'opera porta, ed è una chiave, non un verdetto. Nell'uso corrente *nero* dice due cose diverse — il colore politico di una parte, e ciò che resta in ombra perché non è stato desecretato, non è stato trovato, o non è stato cercato — e **il libro lo impiega nel secondo senso**, che è il senso in cui l'ombra si misura: le centoquarantadue celle aperte, gli Stati Zero con la sede nominata, i fascicoli che le sedi — italiane, tedesche, spagnole, portoghesi, vaticane, statunitensi — non hanno restituito. *Chi lo leggesse nel primo senso leggerebbe una tesi che il libro non sostiene:* di neri, in queste pagine, ce ne sono ai gradi **A**, **B** e **F**, e accanto a loro ce ne sono altri — apparati dello Stato, servizi alleati, uffici, banche, curie — che nessun colore contiene.

**Sul secolo e sulla Bella Europa.** *Il Secolo Nero della Bella Europa* è la formula del titolo, e va detto che cosa vi è di verificabile e che cosa no. **Il secolo è una misura del tempo**: il corpus corre dal 1917 al 2026, e *cento* è un conto tondo — ne corrono **centonove** — tenuto perché un titolo dichiara una misura, non una misurazione. **«La Bella Europa» non è un accertamento**: è un giudizio di valore, e nessun grado di prova lo copre né potrebbe. La formula regge una cosa sola, ed è quella che il libro documenta: che **gli anni in cui il continente costruì il suo massimo** — le costituzioni antifasciste, la ricostruzione, il mercato comune, la libertà di circolare — **sono gli stessi anni in cui corsero le vicende qui registrate**, e in più d'un caso furono gli stessi uffici a fare l'una cosa e a coprire l'altra. *Contemporaneità non è nesso: è la regola di tutta l'opera, e vale anche quando la frase suona bene.* **E una precisazione di perimetro, perché il titolo non prometta ciò che il corpus non consegna:** il corpus è **italiano di centro**, con ricognizioni documentate su Germania, Spagna, Portogallo, Grecia, Turchia e Santa Sede e con l'apparato euro-parlamentare dei capitoli sulle Europe; *non è una storia d'Europa*, ed è dall'Italia che guarda l'Europa.
...
**Sul numero, e su un numero che se ne va.** In copertina i numeri sono due, e non coincidono: l'occhiello dice ~~*ottanta anni*~~ e l'argomento dice *100 anni*. **Nessuno dei due è un conteggio.** *Ottanta* misurava dal maggio 1945, e ne corrono **ottantuno**; *cento* misura dal 1917, e ne corrono **centonove**. **Si tengono entrambi perché misurano due cose diverse** — la pace mancata del dopoguerra, e il secolo delle visioni che si contendono il continente — e **si annotano perché quest'opera ha già pagato una volta per un numero scritto a mano, e non lo lascia passare nemmeno sulla propria copertina**. *La correzione sta accanto all'errore, come sempre: la cifra tonda non è stata riscritta esatta, è stata dichiarata tonda.*

**Sulla proposizione.** *La Seconda Guerra Mondiale non è Finita* **è una cornice, non una tesi accertata.** Il Libro quarto la tratta come tale: la continuità di uomini, strutture e casse attraverso il 1945 è documentata ai gradi **A**, **B** ed **F**, voce per voce, con la sede accanto — **in questo senso preciso, e solo in questo, la proposizione regge**. Ciò che non regge, e che il libro dimostra non reggere, è la pretesa ulteriore: **che «la guerra» sia un solo soggetto, con una sola regia che attraversa il secolo.** *Una radice comune non è un comando comune, e la somma delle guerre non è un soggetto.* **La formula è al presente indicativo e va letta come il libro la usa**: non «prosegue il conflitto del 1939-45», ma *non è finita la partita che quel conflitto aveva aperto* — quale ordine avrebbe l'Europa, e chi lo scrive.

**Sulle quattro visioni, e su una quinta che manca.** L'argomento in copertina nomina **quattro** posizioni — *la Federazione*, *l'Europa delle Nazioni*, il *Quarto Reich*, il *Nazi-Bolscevismo Euroasiatico* — e il corpus ne ha censite **cinque**, con una mappa delle posizioni documentate. La corrispondenza va scritta, perché il lettore possa contestarla: *la Federazione* è la **federazione dei diritti**; *l'Europa delle Nazioni* è la **posizione confederale**; il *Quarto Reich* è ciò che il corpus chiama **il Nuovo Ordine**; il *Nazi-Bolscevismo Euroasiatico* è **l'Europa da Lisbona a Vladivostok**. **La quinta non è in copertina, e la sua assenza è proprio la confusione che il corpus segnala**: *l'Europa Nazione* — il continente come una nazione sola — **non è l'Europa delle nazioni**, che vuole più sovranità nazionale e non meno; **le due formule si somigliano nel nome e si oppongono nella sostanza**, e chi le somma sbaglia il conto.

**E i due nomi più forti dell'argomento vanno accompagnati da ciò che il corpus ha trovato quando li ha contati.** *Quarto Reich* e *Nazi-Bolscevismo Euroasiatico* **non sono denominazioni di soggetti accertati**: sono formule polemiche, e il libro le usa come chiavi di lettura — grado **C** — non come nomi di enti. Il censimento dei seggi europei dà su di esse un risultato che va detto in copertina e non nascosto in appendice: **come piattaforme dichiarate, quelle due Europe hanno zero rappresentanza parlamentare europea**. *Non significa che quelle idee non circolino* — la loro genealogia, le operazioni d'influenza documentate e la radice italiana del filone hanno ciascuna il proprio capitolo. **Significa che nessuno si presenta alle elezioni sotto quel nome, e che chi sostiene il contrario deve indicare il gruppo.** *Un titolo può nominare un timore; un registro deve contarlo.*
...
**Prologo · La scala Savona, e che cosa un livello non dice**
...
11. I numeri della P2: il residuo, e una distinzione che le sintesi non fanno
12. Un ente non è un uomo: anatomia di una riga

**Libro terzo · Gli strumenti, e il giorno in cui si sono rotti**

13. Il metodo: la disciplina, e ciò che non si negozia
14. La matrice delle omissioni: che cosa non fu fatto, e perché quasi nulla lo spiega
15. Il parallelo delle due piste: il metodo e trenta studi
16. Il registro delle promozioni: che cosa alzerebbe ogni grado, e dove sta

**Libro quarto · La cornice lunga, e la sola misura che le si può applicare**

17. Il colpo e la grazia: il Tribunale Speciale, l'amnistia, e la battaglia che si vinse senza combatterla
18. L'isomorfismo e la teoria dei Papi
19. Il ponte con un nome: Roy Cohn, e come si tengono insieme mondi separati
20. Gli strumenti e la finalità: Aginter, le strutture parallele, e un uomo che attraversò tre continenti
21. La continuità degli affari e dei ranghi: Norimberga, le grazie, Bad Harzburg
22. L'asse e l'Ostpolitik: un'internazionale provata, e un fronte che finì per eseguire ciò che combatteva
23. Moro, le transizioni europee e la Santa Sede

**Libro quinto · Le catene lunghe, e i punti in cui si sono rotte**

24. Il campo internazionale: il ceppo, Superclan, Hyperion
25. Il decisore iniziale: che cosa un organigramma dice e che cosa non dirà mai
26. Il canale mediterraneo: Giovannone, il lodo, il cablogramma del 16 febbraio
27. Il Mediterraneo conteso: il nucleare iracheno, il Likud, e due nemici che colpirono lo stesso bersaglio
28. Le tre inversioni: revisionismo sionista, destre europee, e una linea che arriva a oggi
29. Il canale che lasciò le carte: Cirillo 1981, e perché Moro è diverso

**Libro sesto · I rifugi, e ciò che dicono degli Stati**

30. Le pene oltre confine: quando il giudicato non arriva

**Libro settimo · Ciò che non si è potuto aprire**

31. Il quesito della sabbia: le domande, nell'ordine
32. Le piste aperte, in ordine
33. Chiusura: che cosa deciderebbe
...
*Chi scrive di questo caso comincia sempre da un uomo solo.*
*È il primo errore, ed è di misura: in via Mario Fani*
*morirono in cinque prima che lui morisse,*
*e le loro cinque morti non sono il contesto della sua.*

**Oreste Leonardi**, maresciallo dei carabinieri, cinquantadue anni.
**Domenico Ricci**, appuntato, quarantatré.
**Giulio Rivera**, guardia di pubblica sicurezza, ventiquattro.
**Francesco Zizzi**, vicebrigadiere, trenta.
**Raffaele Iozzino**, guardia di pubblica sicurezza, venticinque.

*Cinque uomini che quella mattina facevano un lavoro,*
*e il lavoro era stare fra un altro uomo e ciò che poteva ucciderlo.*
*Lo fecero. Fu inutile. Non è la stessa cosa.*

**Aldo Moro**, sessantuno anni, presidente della Democrazia Cristiana.

*Sei. Non uno.*
*E il conto va rifatto ogni volta, perché ogni volta si perde:*
*la memoria è una macchina che risparmia,*
*e risparmia sui nomi che non aggiungono niente alla trama.*

**È la prima regola di questo libro, ed è morale prima che metodologica:
una ricostruzione che tratti cinque morti come lo sfondo del sesto ha già
sbagliato, e sbaglierà anche il resto.**

---

## Ciò che questo libro è, e in che ordine procede

**Novanta secondi.** Tanto durò l'agguato del **16 marzo 1978**, in circa
novanta secondi, all'incrocio fra via Mario Fani e via Stresa, a Roma.

**Quarantotto anni.** Tanto è durato ciò che è venuto dopo: cinque processi,
tre commissioni parlamentari, biblioteche, film, congetture, un fascicolo
ancora aperto in una procura.

**Il rapporto fra questi due numeri è l'oggetto del libro.** Non «chi è stato»
— quello lo dicono cinque sentenze, e questo libro le riporta prima di ogni
altra cosa. Ma **perché un fatto di novanta secondi, giudicato in via
...
un uomo che scende da un'auto blindata che non era blindata. Si racconta come
Böll racconta le macchine che schiacciano le persone: **dal basso, con i
nomi, e senza sconti su chi guarda.**

**La seconda fabbrica in quarantotto anni.** È semiotica: nomi che diventano
sigle, sigle che diventano catene, calendari che si accorciano, cognomi che si
scambiano. Si racconta come Eco racconta le trame: **mostrando il meccanismo,
e mostrando che il meccanismo funziona anche quando non c'è niente da
spiegare.**

**E fra le due macchine sta un apparato di strumenti** — gradi, calendari,
registri, celle aperte — che questo corpus ha costruito per non essere né
...
*È quanto sappiamo di saperlo.*

---

# Prologo · La scala Savona, e che cosa un livello non dice

*Prima dell'elenco viene il metro,*
*e non per pedanteria:*
*perché un elenco senza il suo metro non è un elenco —*
*è una lista di nomi, e una lista di nomi in un libro su un delitto*
*viene letta in un modo solo, quale che sia l'intenzione di chi l'ha scritta.*

*Chi legge un nome sotto un titolo che dice «livello A»*
*capisce «colpevole al massimo grado», e ha torto,*
*ma ha torto in un modo che è colpa di chi ha stampato la lista*
*senza stampare prima che cosa quella A misuri.*

*Dunque prima il metro. Poi l'elenco.*
*E fra i due, la riga che li tiene separati per sempre.*

---

## Perché questo prologo sta qui, e che cosa resta prima di lui

Quest'opera si apre, e continuerà ad aprirsi, con **la dichiarazione di generazione e con i sei nomi**: Leonardi, Ricci, Rivera, Zizzi, Iozzino, Moro. Non sono un capitolo — sono il frontespizio, e il libro intero esiste in ragione loro. **Nessun apparato di misura precede sei morti**, e questa è la sola cosa che questo prologo non sposta.

Subito dopo, però, e prima di ogni narrazione, sta questo: **il metro con cui il corpus da cui il libro deriva ha misurato le proprie connessioni**, e l'elenco integrale di ciò che quel metro ha certificato.

Sta qui per una ragione precisa. Il corpus non è un archivio di fatti: è un archivio di **legami** — chi era in contatto con chi, quale struttura confinava con quale altra, quale ambiente ospitò quale altro. E un archivio di legami è lo strumento più pericoloso che si possa costruire, perché **produce catene con la stessa facilità con cui produce conoscenza**, e le due cose si somigliano fino a essere indistinguibili a occhio nudo.

La Scala Savona è ciò che il corpus ha costruito per distinguerle. **Metterla in fondo, fra gli apparati, sarebbe stato un errore di architettura**: si sarebbe letto tutto il libro con l'occhio nudo, e si sarebbe trovato lo strumento solo dopo aver preso l'abitudine di farne a meno.

---

## Da dove viene il nome, e a che cosa serve

La Scala Savona nasce nel ramo **`italia-nera`** del corpus — quello che censisce le strutture, gli ambienti e i loro archi — e vi è definita come **scala di triangolazione**. La parola conta: non misura *quanto una cosa sia vera*, misura **da quante direzioni indipendenti si sia arrivati a vederla**.

Nella sua forma originaria è **tripartita**, e la definizione è questa, alla lettera:

> **Livello A** — la connessione **documentata** da **almeno tre fonti indipendenti di natura diversa**.
>
> **Livello B** — la connessione **indiziaria**, sorretta da **due fonti indipendenti** oppure da **una singola fonte di alta affidabilità**.
>
> **Livello C** — la connessione **ipotetica**, basata su **una fonte singola** o su **indizi circostanziali**.

E accanto ai tre livelli, due istituti che sono la parte più originale dell'apparato.

**Lo Stato Zero.** Una connessione **sistematicamente cercata e non trovata** si registra come Stato Zero, che nella metodologia dell'opera è **«un risultato di prima classe, non una lacuna da colmare»**. È lo stesso istituto che il libro adopera in tutte le sue pagine, e nasce qui.

**La Regola Ferrea.** *Nessun salto inferenziale fra piani probatori distinti* — e, nominato per esteso perché è il salto che tutti compiono, **il divieto di inferire il mandato dalla copertura**.

Chi ha letto il Libro settimo di quest'opera, e la voce che dichiara perché non esista una pista sul mandante, riconoscerà qui la sua origine. **Non è una scelta di prudenza politica: è una regola scritta prima, e applicata dopo.**

---

## Il difetto che la scala si trovò addosso, e come lo corresse

Una scala tripartita ha un guasto strutturale, e il corpus se lo diagnosticò da solo. **Comprime due cose diverse in un giudizio unico**, e ne derivano tre errori nominati.

**L'aliasing epistemico.** Due archi classificati entrambi **B** possono avere robustezza profondamente diversa: l'uno viene da una **fonte forte con descrizione debole** del legame, l'altro da una **fonte intermedia con descrizione forte**. Il giudizio sintetico li tratta come equivalenti, e non lo sono.

**L'opacità procedurale.** Chi riceve un **B** non sa **da quale delle due metà** venga la debolezza, e dunque **non può sapere quale verifica servirebbe** per alzarlo. Un grado che non dice come si alza è un grado che non si può lavorare.

**La sotto-utilizzazione delle fonti deboli.** Una memoria, un'intervista, un saggio non accademico — fonte di livello D — finisce sempre a sostenere un legame **C**, anche quando **descrive il legame con un dettaglio che, su una scala più fine, ne giustificherebbe uno superiore**.

La correzione fu di **sdoppiare la scala nelle sue due componenti epistemiche distinte**.

---

## Savona-fonte: cinque livelli di attendibilità intrinseca

Valuta **la fonte**, indipendentemente da che cosa la fonte affermi.

**A — attendibilità massima.** Sentenze definitive della magistratura italiana o di magistrature estere riconosciute; atti normativi primari; relazioni approvate di Commissioni parlamentari d'inchiesta; decisioni definitive di organi giurisdizionali sovranazionali; atti primari di organi costituzionali pubblicati in Gazzetta Ufficiale. *Attendibile non perché immune da errore — un giudicato può essere falsificato da una revisione, una relazione può essere parziale per la composizione della Commissione — ma perché prodotta da un organo investito di autorità che le attribuisce uno statuto probatorio formale.*

**B — alta, non massima.** Sentenze di merito non definitive ma motivate; ordinanze di custodia cautelare; informative di polizia giudiziaria depositate; relazioni DIA e DNA; relazioni semestrali delle Agenzie al Parlamento; atti primari di organi statuali esteri di democrazie consolidate riferiti alle proprie strutture; atti documentari primari di NATO, ONU, Unione Europea, Consiglio d'Europa, OCSE.

**C — intermedia.** Monografie accademiche con referaggio; articoli su riviste con referaggio anonimo; testate di riferimento per la materia; archivi storici desecretati; dossier di centri di ricerca riconosciuti. *Nessuna autorità formale, ma meccanismi professionali di controllo della qualità.*

**D — modesta.** Memorialistica di protagonisti; libri-intervista; saggistica giornalistica; testate generaliste; blog specialistici; dichiarazioni rese fuori dal processo ma documentate. *Non intrinsecamente inaffidabile — può essere molto informativa — ma è testimonianza individuale non filtrata da un meccanismo collettivo.*

**E — debole.** Voci e testimonianze indirette; attribuzioni anonime; provenienza incerta; forum e social; materiali la cui catena di custodia non è verificabile; materiali con evidente finalità polemica o promozionale. *Non si scarta automaticamente — può essere il primo segnale di un fenomeno che fonti superiori confermeranno — ma non può mai da sola sostenere un legame significativo.*

---

## Savona-legame: cinque livelli di solidità inferenziale

Valuta **il legame**, indipendentemente da chi lo racconti.

**1 — co-occorrenza testuale.** Due nomi nello stesso documento, senza che il documento descriva un rapporto. *Stabilisce che una fonte ha avuto motivo di citarli insieme. Nient'altro.* Da sola **non giustifica la creazione di un arco**.

**2 — menzione contestuale significativa.** La fonte li colloca in un contesto comune che lascia intendere una relazione, **senza descriverla**. Due imputati nello stesso capo d'imputazione; due organizzazioni nello stesso capitolo su una strategia. *Giustifica un arco, marcato come contestuale.*

**3 — collegamento descritto con supporto esplicito.** La fonte **dice che cosa lega** le due entità: natura, direzione, funzione. **È il livello standard del lavoro analitico**, e la maggior parte degli archi vi si costruisce.

**4 — collegamento corroborato da più fonti autonome.** Almeno **due fonti di livello pari o superiore a C**, indipendenti per provenienza, metodo e filiera redazionale. *Il «pari o superiore a C» discrimina la corroborazione genuina dalla pseudo-corroborazione prodotta da fonti che si copiano fra loro.*

**5 — collegamento giudizialmente accertato o istituzionalmente consolidato.** Sentenza definitiva che lo stabilisce come fatto giuridico; atto normativo primario che lo riconosce; atti istituzionali primari di un'autorità competente sull'oggetto. *Massimo grado ottenibile, e corrisponde al criterio del giudicato.*

---

## La matrice, e la regola di compressione

Le due scale producono una **matrice cinque per cinque, venticinque celle**. La cella **A-5** è il massimo: una sentenza definitiva che accerta un legame come fatto giuridico. La cella **E-1** è il minimo registrabile.

**E le celle fuori diagonale sono le più interessanti**, perché segnalano le asimmetrie.

**A-1** è il caso paradossale: **una sentenza definitiva che registra solo una co-occorrenza di due nomi senza descrivere alcun legame.** Fonte massima, legame minimo. Chi classificasse guardando solo la fonte scriverebbe **A**; la robustezza reale è bassa.

**D-4**: una memorialistica che descrive un legame con grande dettaglio, corroborata da un'altra fonte autonoma superiore. **Fonte modesta, legame solido.**

La compressione ai tre livelli originari è dunque questa, ed è **asimmetrica di proposito**:

> **Savona A** — fonte **A** con legame **≥ 4**; **oppure** fonte **B** con legame **5**; **oppure** legame **5** qualunque sia la fonte, purché almeno **D**.
>
> **Savona B** — fonte **A** con legame **3**; **oppure** fonte **B o C** con legame **4**; **oppure** fonte **B o C** con legame **3** corroborata da una seconda fonte autonoma **≥ D** con legame **≥ 3**.
>
> **Savona C** — tutti gli altri casi, escluse le configurazioni che non superano la soglia minima della cella **E-1 isolata**.

L'asimmetria ha una ragione dichiarata: **la solidità del legame è strutturalmente più discriminante dell'attendibilità della fonte.** Una fonte massima con legame minimo **non produce conoscenza relazionale**, perché non racconta che cosa leghi le entità. Una fonte modesta con legame massimo e corroborato **la produce**.

---

## E oltre Savona: perché **Savona A non è grado A**

Questa è la sezione per cui il prologo esiste, e va letta due volte.

**Le due scale che quest'opera adopera non sono la stessa scala, e la lettera «A» significa in esse due cose diverse.**

| | **grado A** (scala del caso Moro) | **Savona A** (scala di triangolazione) |
|---|---|---|
| che cosa misura | **la specie della fonte** | **il numero e l'indipendenza delle fonti** |
| che cosa significa | **giudicato definitivo** | connessione documentata da **≥ 3 fonti indipendenti di natura diversa** |
| oggetto | un **fatto** o una **condotta** | un **arco** fra due entità |
| chi lo pronuncia | un **tribunale** | un **ricercatore che conta** |

Dalla regola di compressione discende, con la forza di un'aritmetica, la conseguenza che nessuna sintesi divulgativa scrive mai:

> **Un giudicato produce sempre un Savona A. Un Savona A non prova mai un giudicato.**

Il primo verso è immediato: legame **5** con fonte **A** cade dentro Savona A. Il secondo è il punto: **Savona A si raggiunge anche per la via «fonte A con legame 4»**, e il legame 4 è **corroborazione da due fonti autonome**, non una sentenza. **Il grado A del caso Moro è un sottoinsieme proprio di Savona A**, e chi legge la seconda A come la prima ha compiuto, in un carattere tipografico, l'intero salto che la Regola Ferrea vieta.

C'è poi la differenza che conta di più, e non è di soglia ma **di oggetto**.

> **Il grado A si attribuisce a un fatto o a una condotta. Il livello Savona si attribuisce a un arco.**
>
> **Un arco non è una condotta. Un arco è una relazione fra due nomi, documentata da un certo numero di fonti.**

Ne segue la riga che tiene separate le due liste che chiudono questo prologo, e che va scritta nel modo più netto di cui si dispone:

**Nessuna persona nominata nelle pagine seguenti ha un livello Savona.** Le persone e le entità **compaiono** in archi che ne hanno uno. **Attribuire a una persona il livello dell'arco in cui compare è un errore di categoria**, ed è precisamente il meccanismo che il Libro secondo di quest'opera descrive come *la macchina che fabbrica*: il passaggio dal nome alla sigla, dalla sigla alla catena, dalla catena alla colpa.

---

## La dimostrazione, ed è dentro l'elenco stesso

L'elenco che segue contiene, al numero **13**, l'arco **«Iperíon → Mosca-Praga → BR-Moro»**, classificato **Savona B**.

Il ramo di quest'opera dedicato al caso Moro dice, dello stesso oggetto, tre cose. Che la genealogia è documentata ai gradi **F** e **B**. Che **tutti i procedimenti aperti su Hyperion e sui suoi fondatori si sono chiusi con proscioglimenti, e nessuno è mai stato condannato**. E che i nessi operativi sono stati **archiviati all'indice 0,1** per anello debole, perché ogni cammino da quella genealogia a via Fani passa per **archi biografici**, e un arco biografico non è un arco di condotta.

**Le due affermazioni non si contraddicono, e capire perché è capire l'intero apparato.** Un **Savona B** dice: *questa connessione è indiziaria e poggia su due fonti indipendenti o su una fonte di alta affidabilità.* Non dice, e non può dire, *qualcuno ha fatto qualcosa*. **Fra le due frasi c'è tutta la distanza che separa una biblioteca da un tribunale**, e questo prologo esiste per non lasciarla attraversare per distrazione.

*Un arco misura quanto si è visto.*
*Un giudicato misura che cosa è stato fatto.*
*Confonderli non è un'imprecisione:*
*è il modo in cui un nome, senza che nessuno menta,*
...
Ciò che segue è **generato**, non scritto a mano, e ricontato a ogni assemblaggio dell'opera — perché un elenco scritto a mano deriva, e questa opera ha già pagato una volta per averlo imparato.

Sono **due liste, e restano due**. La prima porta i livelli, perché il livello appartiene all'arco. **La seconda non ne porta**, e il numero che vi compare accanto a ciascuna etichetta **misura la ricorrenza, non la responsabilità**: dice in quanti archi quel nome è nominato, e nient'altro.

Le etichette sono riprodotte **come il corpus le scrisse**, composte incluse: non si spezzano sul trattino, perché dentro un'etichetta il trattino tiene insieme nomi propri, e spezzarlo fabbricherebbe nomi che nessuna fonte ha scritto.

## Gli archi, con il loro livello

| # | arco | livello |
|---:|---|:-:|
| 1 | Arco 01 — Gelli–P2 → Argentina-Massera-ESMA (Filiazione) | **A** |
| 2 | Arco 02 — Delle Chiaie → Cile-DINA-Bolivia-Barbie (Proiezione) | **A** |
| 3 | Arco 03 — Aginter Press → Spagna-Portogallo-Medio Oriente (Filiazione) | **A** |
| 4 | Arco 04 — Lupi Grigi → Ağca → attentato Giovanni Paolo II (Filiazione) | **A** |
| 5 | Arco 05 — Cosa Nostra USA → Cuba-Mongoose → JFK (Eredità) | **A** |
| 6 | Arco 06 — Trafficante Tampa → Sicilia-Cianciana (Eredità) | **A** |
| 7 | Arco 07 — Ndrangheta → Sinaloa-CJNG → Cocaina europea (Filiazione) | **A** |
| 8 | Arco 08 — Gladio → Stay-Behind NATO globale (Isomorfismo) | **A** |
| 9 | Arco 09 — P2 → P-Reti europee (Isomorfismo) | **A** |
| 10 | Arco 10 — Sindona-Calvi → IOR-Banchi vaticani-Estero (Filiazione) | **A** |
| 11 | Arco 11 — Andreotti → Lima-Ciancimino-Bontate (Filiazione) | **A** |
| 12 | Arco 12 — Trattativa Stato-Mafia → Borsellino-Mori-Subranni (Eredità) | **A** |
| 13 | Arco 13 — Iperíon → Mosca-Praga → BR-Moro (Filiazione) | **B** |
| 14 | Arco 14 — Andropov-Brezhnev → PCI-Berlinguer (Filiazione) | **B** |
| 15 | Arco 15 — GRU-KGB → terrorismo italiano (Convergenza) | **B** |
| 16 | Arco 16 — Russia post-1991 → Mafie italiane-Bratva (Riemergenza) | **B** |
| 17 | Arco 17 — Lodo Moro → Palestina-Italia (Strumentalizzazione) | **A** |
| 18 | Arco 18 — Sismi-Mossad → Affari Achille Lauro-Sigonella (Convergenza) | **A** |
| 19 | Arco 19 — Hezbollah-Iran-Hamas-Iraq (Asse strutturale) | **A** |
| 20 | Arco 20 — Pennsylvania-Gülen → Turchia (Pattern 14 Sanctuary) | **A** |
| 21 | Arco 21 — Saudita Khashoggi → Istanbul-MbS (Pattern 14 inverso) | **A** |
| 22 | Arco 22 — Pakistan-ISI → Al-Qa'ida-Bin Laden Abbottabad (Pattern 14) | **A** |
| 23 | Arco 23 — Iran-Pasdaran-IRGC → Mercati globali nucleari (Filiazione) | **A** |
| 24 | Arco 24 — ISIS-Da'esh → Siria-Iraq-Europa (Convergenza) | **A** |
| 25 | Arco 25 — Wagner-Prigozhin → Africa-Sub-Sahara (Filiazione) | **A** |
| 26 | Arco 26 — Bannon-Steve Miller → Le Cercle moderna (Filiazione ideologica) | **B** |
| 27 | Arco 27 — Trump → Salvini-Meloni-Orbán-Milei-Modi-Erdoğan (Convergenza) | **A** |
| 28 | Arco 28 — Putin-Dugin → Eurasiismo-Estrema destra europea (Filiazione) | **A** |
| 29 | Arco 29 — Wojtyła-Reagan-Casey → Solidarność-Polonia (Convergenza) | **A** |
| 30 | Arco 30 — Murdoch-Berlusconi → Mediasystem globale (Isomorfismo) | **A** |
| 31 | Arco 31 — Panama Papers → Mossack Fonseca-Vatican-Mafie (Convergenza) | **A** |
| 32 | Arco 32 — Pandora Papers → Off-shore globale (Riemergenza) | **A** |
| 33 | Arco 33 — Cripto-FTX-Bankman-Fried → Wall Street-Politica USA (Convergenza) | **A** |
| 34 | Arco 34 — Operazione Husky 1943 → Cosa Nostra-OSS (Filiazione) | **A** |
| 35 | Arco 35 — Andreotti-Federici-Giuliano → Portella della Ginestra (Filiazione) | **A** |
| 36 | Arco 36 — Piano Solo 1964 → De Lorenzo-Carabinieri-Segni (Filiazione) | **A** |
| 37 | Arco 37 — Borghese-Delle Chiaie-CIA → Tentato Golpe 1970 (Filiazione) | **A** |
| 38 | Arco 38 — Piazza Fontana 1969 → Freda-Ventura-Giannettini (Filiazione) | **A** |
| 39 | Arco 39 — Strage Brescia 1974 → Ordine Nuovo-Maggi (Filiazione) | **A** |
| 40 | Arco 40 — Italicus 1974 → Bombe Ferrovie-NAR-Eversione nera (Filiazione) | **A** |
| 41 | Arco 41 — Ustica 1980 → Itavia-NATO-Libia-Battaglia aerea (Convergenza) | **A** |
| 42 | Arco 42 — Bologna 1980 → NAR-Servizi inquinati-Banda Magliana (Filiazione) | **A** |
| 43 | Arco 43 — Capaci-via D'Amelio 1992 → Riina-Bagarella-Mori (Filiazione) | **A** |
| 44 | Arco 44 — Stragi continentali 1993 → Firenze-Roma-Milano (Filiazione) | **A** |
| 45 | Arco 45 — Aldrovandi-Cucchi 2005-2009 → Polizia-Repressione (Pattern emergente) | **B** |
| 46 | Arco 46 — Ndrangheta-Pelle Bonefro → Toronto-Australia-Germania (Filiazione) | **A** |
| 47 | Arco 47 — Yakuza-Triadi-Italia (Pattern Hub-Convergenza) | **B** |
| 48 | Arco 48 — Bratva-Vory v Zakone-Italia (Filiazione) | **A** |
| 49 | Arco 49 — Fratelli Musulmani Egitto → Hamas-Erdoğan-Qatar (Filiazione) | **A** |
| 50 | Arco 50 — Sionismo Religioso → Smotrich-Ben Gvir-Coalizione 2022 (Filiazione) | **A** |
| 51 | Arco 51 — Vatican-Opus Dei-CL → Politica italiana (Convergenza) | **A** |
| 52 | Arco 52 — Leonardo-MBDA-Fincantieri → NATO-Mercati globali (Filiazione) | **A** |
| 53 | Arco 53 — BAE-Lockheed-Raytheon → Mercati globali (Pattern globale) | **A** |
| 54 | Arco 54 — Stuxnet 2010 → Israele-USA-Iran (Filiazione) | **A** |
| 55 | Arco 55 — Pegasus-NSO Group → Sorveglianza globale (Pattern Hub) | **A** |
| 56 | Arco 56 — Doppelgänger-Sandworm-APT28 → Disinformazione globale (Convergenza) | **A** |

## Le entità nominate negli archi

*Senza livello, per la ragione detta sopra. Il numero è quello degli archi in cui l'etichetta compare: **misura la ricorrenza, non la responsabilità**.*

*Le etichette sono riprodotte come il corpus le scrisse, composte incluse. Non si spezzano sul trattino: dentro un'etichetta il trattino tiene insieme nomi propri, e spezzarlo fabbricherebbe nomi che nessuna fonte ha scritto.*

| etichetta | archi |
|---|---:|
| Affari Achille Lauro-Sigonella | 1 |
| Africa-Sub-Sahara | 1 |
| Aginter Press | 1 |
| Al-Qa'ida-Bin Laden Abbottabad | 1 |
| Aldrovandi-Cucchi 2005-2009 | 1 |
| Andreotti | 1 |
| Andreotti-Federici-Giuliano | 1 |
| Andropov-Brezhnev | 1 |
| Argentina-Massera-ESMA | 1 |
| Ağca | 1 |
| BAE-Lockheed-Raytheon | 1 |
| BR-Moro | 1 |
| Bannon-Steve Miller | 1 |
| Bologna 1980 | 1 |
| Bombe Ferrovie-NAR-Eversione nera | 1 |
| Borghese-Delle Chiaie-CIA | 1 |
| Borsellino-Mori-Subranni | 1 |
| Bratva-Vory v Zakone-Italia | 1 |
| Capaci-via D'Amelio 1992 | 1 |
| Cile-DINA-Bolivia-Barbie | 1 |
| Cocaina europea | 1 |
| Cosa Nostra USA | 1 |
| Cosa Nostra-OSS | 1 |
| Cripto-FTX-Bankman-Fried | 1 |
| Cuba-Mongoose | 1 |
| De Lorenzo-Carabinieri-Segni | 1 |
| Delle Chiaie | 1 |
| Disinformazione globale | 1 |
| Doppelgänger-Sandworm-APT28 | 1 |
| Eurasiismo-Estrema destra europea | 1 |
| Firenze-Roma-Milano | 1 |
| Fratelli Musulmani Egitto | 1 |
| Freda-Ventura-Giannettini | 1 |
| GRU-KGB | 1 |
| Gelli–P2 | 1 |
| Gladio | 1 |
| Hamas-Erdoğan-Qatar | 1 |
| Hezbollah-Iran-Hamas-Iraq | 1 |
| IOR-Banchi vaticani-Estero | 1 |
| ISIS-Da'esh | 1 |
| Iperíon | 1 |
| Iran-Pasdaran-IRGC | 1 |
| Israele-USA-Iran | 1 |
| Istanbul-MbS | 1 |
| Italicus 1974 | 1 |
| Itavia-NATO-Libia-Battaglia aerea | 1 |
| JFK | 1 |
| Le Cercle moderna | 1 |
| Leonardo-MBDA-Fincantieri | 1 |
| Lima-Ciancimino-Bontate | 1 |
| Lodo Moro | 1 |
| Lupi Grigi | 1 |
| Mafie italiane-Bratva | 1 |
| Mediasystem globale | 1 |
| Mosca-Praga | 1 |
| Mossack Fonseca-Vatican-Mafie | 1 |
| Murdoch-Berlusconi | 1 |
| NAR-Servizi inquinati-Banda Magliana | 1 |
| NATO-Mercati globali | 1 |
| Ndrangheta | 1 |
| Ndrangheta-Pelle Bonefro | 1 |
| Off-shore globale | 1 |
| Operazione Husky 1943 | 1 |
| Ordine Nuovo-Maggi | 1 |
| P-Reti europee | 1 |
| PCI-Berlinguer | 1 |
| Pakistan-ISI | 1 |
| Palestina-Italia | 1 |
...
| Pandora Papers | 1 |
| Pegasus-NSO Group | 1 |
| Pennsylvania-Gülen | 1 |
| Piano Solo 1964 | 1 |
| Piazza Fontana 1969 | 1 |
| Politica italiana | 1 |
| Polizia-Repressione | 1 |
| Portella della Ginestra | 1 |
| Putin-Dugin | 1 |
| Riina-Bagarella-Mori | 1 |
| Russia post-1991 | 1 |
| Salvini-Meloni-Orbán-Milei-Modi-Erdoğan | 1 |
| Saudita Khashoggi | 1 |
| Sicilia-Cianciana | 1 |
| Sinaloa-CJNG | 1 |
| Sindona-Calvi | 1 |
...
| Siria-Iraq-Europa | 1 |
| Sismi-Mossad | 1 |
| Smotrich-Ben Gvir-Coalizione 2022 | 1 |
| Solidarność-Polonia | 1 |
| Sorveglianza globale | 1 |
| Spagna-Portogallo-Medio Oriente | 1 |
| Stay-Behind NATO globale | 1 |
| Strage Brescia 1974 | 1 |
| Stragi continentali 1993 | 1 |
| Stuxnet 2010 | 1 |
| Tentato Golpe 1970 | 1 |
| Toronto-Australia-Germania | 1 |
| Trafficante Tampa | 1 |
| Trattativa Stato-Mafia | 1 |
| Trump | 1 |
| Turchia | 1 |
| Ustica 1980 | 1 |
| Vatican-Opus Dei-CL | 1 |
| Wagner-Prigozhin | 1 |
| Wall Street-Politica USA | 1 |
| Wojtyła-Reagan-Casey | 1 |
| Yakuza-Triadi-Italia | 1 |
| attentato Giovanni Paolo II | 1 |
| terrorismo italiano | 1 |
...
- `_tomi/` — tomi ricomposti: ripetono archi gia' contati
...
*Si comincia sempre dall'ora sbagliata.*
*Si comincia dalle nove meno un quarto, dal fuoco, dai bossoli sull'asfalto —*
*e non dalle sei del mattino, quando cinque uomini si vestirono*
*e uno di loro, che aveva cinquantadue anni, si allacciò le scarpe*
*pensando a un giovedì come gli altri.*

*Le macchine che uccidono hanno questo di crudele:*
*cominciano molto prima di cominciare,*
*e chi le racconta le fa partire sempre dall'ultimo minuto,*
*perché l'ultimo minuto è l'unico che faccia spettacolo.*

---

## 1. L'ora, il luogo, i sei

Giovedì **16 marzo 1978**, Roma, quartiere Trionfale. All'incrocio fra **via Mario Fani** e **via Stresa**, in circa **novanta secondi**, un'azione di fuoco uccise cinque uomini e ne fece prigioniero un sesto.

I cinque si chiamavano **Oreste Leonardi**, maresciallo dei carabinieri, cinquantadue anni; **Domenico Ricci**, appuntato, quarantatré; **Giulio Rivera**, guardia di pubblica sicurezza, ventiquattro; **Francesco Zizzi**, vicebrigadiere, trenta; **Raffaele Iozzino**, guardia di pubblica sicurezza, venticinque. Il sesto, **Aldo Moro**, sessantuno anni, presidente della Democrazia Cristiana, sarebbe stato ucciso cinquantacinque giorni dopo, il **9 maggio 1978**.

Questa è la prima frase del libro e non è una premessa: è un **vincolo di scrittura**. Nel giudicato le sei morti stanno insieme — le condanne definitive parlano del sequestro e dell'omicidio di Aldo Moro *e dell'eccidio della scorta*, sei vittime di uno stesso fatto criminoso. Non una vicenda principale con un contorno. Nella pubblicistica, invece, i cinque si assottigliano di decennio in decennio fino a diventare una locuzione — «la scorta» — e poi un numero, e poi niente.

**È il primo lavoro che una macchina di fabbricazione compie, e lo compie prima di ogni congettura: riduce le persone a funzioni.** Cinque uomini diventano un dispositivo di protezione; un dispositivo di protezione diventa un dettaglio tecnico dell'agguato; un dettaglio tecnico si può omettere. Il capitolo che segue mette in fila le cose materiali di quei novanta secondi. Ma le mette in fila **dopo** i nomi, e non per cortesia: perché l'ordine in cui si dispongono i fatti è già una tesi, e questa è la nostra.

Rivera aveva ventiquattro anni. Iozzino ne aveva venticinque. Fu l'unico dei cinque che riuscì a scendere dall'auto e a rispondere al fuoco.

---

## 2. Che cosa fa una macchina, materialmente

Una macchina che uccide non è una metafora. È fatta di pezzi, e i pezzi lasciano tracce misurabili. Questo paragrafo elenca i pezzi accertati, con il loro grado, e non aggiunge nulla.

**Il fuoco.** La perizia balistica del 1978 — il collegio **Ugolini-Iadevito-Lopez** — stabilì che in via Fani furono esplosi **almeno 91 colpi**, da **sei armi**: quattro mitra e due pistole. *Grado B.*

**La firma.** Di quei colpi, **49 bossoli** furono attribuiti a **una sola arma**, un mitra **FNAB-43**. Non è un relitto peritale degli anni Settanta: l'attribuzione è stata **confermata** dall'esame del Servizio Polizia scientifica illustrato alla Commissione parlamentare il **10 giugno 2015**. *Grado B.*

**Ciò che la firma non regge.** L'attribuzione di **22 colpi** a un secondo mitra, già messa in dubbio dalla perizia del 1993, è stata dal medesimo esame del 2015 **declassata a esito non conclusivo**. *Grado B.* Un esame vero si comporta così: conferma una cosa, ne demolisce un'altra, e non chiede a chi lo legge di scegliere quale metà gli convenga.

**Ciò che cade.** La ricostruzione della dinamica **contraddice** la figura di un unico «superkiller» che avrebbe sparato da solo la parte decisiva dei colpi. *Grado B.*

**Chi.** Il giudicato — cinque processi, dal 1983 al 1999 — ha accertato che l'agguato, la prigionia e l'uccisione furono opera delle **Brigate Rosse**, e ha attribuito **tredici responsabilità personali**, ciascuna con la propria condotta. *Grado A.* Nessun nome oltre quei tredici entra in queste pagine come responsabile: non uno.

E qui la macchina materiale ha già detto tutto quello che sa dire. Novantuno colpi, sei armi, quarantanove bossoli di una sola canna, novanta secondi, cinque morti, un uomo caricato su un'auto. **Il resto — quarantotto anni di resto — non sta in questi numeri.**

---

## 3. L'auto che non era blindata, e le altre cose che non erano

C'è una categoria di fatti, in questo caso, che non appartiene né al giudicato né alla congettura, e che è la più böllniana di tutte: **le cose che si credevano esistenti e non c'erano.**

L'auto su cui viaggiava Moro non offriva la protezione che il senso comune attribuisce alla parola «blindata». La scorta era armata di ordinanza. Il dispositivo che doveva stare fra un uomo e ciò che poteva ucciderlo era, misurato contro ciò che gli venne addosso, **strutturalmente insufficiente** — e nessuno dei cinque lo ignorava del tutto.

Questo è il punto in cui la narrazione pubblica tende a girare bruscamente verso la congettura: *se la protezione era insufficiente, qualcuno l'ha voluta insufficiente.* Il salto è comprensibile e va nominato per quello che è: **un salto**. Fra «insufficiente» e «voluta insufficiente» ci sono almeno tre gradini — la disorganizzazione ordinaria, il difetto di cultura investigativa, la sottovalutazione condivisa — e ciascuno va pagato separatamente prima di salire al successivo.

Böll non avrebbe fatto quel salto. Avrebbe fatto un'altra cosa, e più dura: avrebbe guardato **il mestiere**. Cinque uomini fanno un lavoro che consiste nello stare fra un altro uomo e ciò che può ucciderlo. Lo fanno con gli strumenti che lo Stato ha deciso di dar loro. Gli strumenti non bastano. Loro non lo sanno abbastanza per rifiutarsi, e non conta: nessuno di loro si sarebbe rifiutato.

*Lo fecero. Fu inutile. Non è la stessa cosa.*

---

## 4. Novanta secondi visti da dentro: perché le testimonianze divergono

Qui la macchina materiale incontra il primo attrito, e l'attrito è umano.

La Commissione parlamentare ha ritenuto **da approfondire** la presenza in via Fani di **due motociclette** — non una — con **quattro persone a bordo**: una in fuga verso via Stresa, l'altra attardata sul luogo. *Grado B, con qualificazione: acquisizione parlamentare, non giudicato.* Due testimoni oculari **mai sentiti prima in quarant'anni** sono stati auditi: un residente di via Fani e un ingegnere, che riferì di una motocicletta Honda e di colpi esplosi nella sua direzione. *Grado B.*

Sono le uniche evidenze che, in questo caso, **discriminino qualcosa**. E per capire che cosa discriminino serve una precisazione che il dibattito pubblico non fa mai.

Sulla composizione di chi agì in via Fani le ipotesi possibili sono quattro, e coprono l'intero campo:

- **F1** — organico coincidente: chi agì è esattamente il commando accertato, nessun estraneo.
- **F2** — presenze estranee **non operative**: qualcuno di estraneo c'era, in osservazione o collegamento, senza sparare.
- **F3** — presenze estranee **operative**: almeno un estraneo partecipò, con un'arma o un mezzo.
- **F4** — presenze **percepite e inesistenti**: le moto e il quarto uomo come prodotto di errori testimoniali su elementi reali ma diversamente spiegabili.

F1 e F4 non sono la stessa ipotesi, e confonderle è l'errore più comune. La prima dice *non c'era nessuno* e ha finito. La seconda dice *ecco perché qualcuno credette di vederli*, ed è la sola delle due che debba **rendere conto** delle testimonianze invece di ignorarle. Chi liquida le terze presenze con un'alzata di spalle sta sostenendo F4, non F1 — e F4 ha oneri propri.

Ed ecco il risultato, che è scomodo per tutti.

| ipotesi | incompatibilità |
|---|:-:|
| **F2** estranei non operativi | 0 |
| **F4** percepiti e inesistenti | 0 |
| **F3** estranei operativi | 1 |
| **F1** organico coincidente | 2 |

**Cinque evidenze su undici si cancellano**: il giudicato e l'intero apparato balistico — i 91 colpi, le sei armi, i 49 bossoli, i 22 contesi, la caduta del superkiller — sono **compatibili con tutte e quattro le ipotesi**. Sono esattamente i fatti che il dibattito pubblico adopera da decenni in entrambe le direzioni, e la ragione per cui **entrambe** le direzioni possono adoperarli è che **non discriminano**.

Il caso più istruttivo è quello dei ventidue colpi declassati. Vengono citati come indizio di un'arma in più, dunque di un uomo in più. Ma *attribuzione non conclusiva* non significa *attribuzione a un altro*: significa che l'esame **non decide**. Un esito non conclusivo è compatibile con l'ipotesi che l'arma fosse del commando **e** con quella che non lo fosse: è, alla lettera, assenza di informazione. Adoperarlo come indizio significa **trasformare un silenzio in una voce**.

E lo stesso errore, rovesciato, si commette dall'altra parte: che un'arma abbia sparato quarantanove colpi non dice **nulla** su quante persone fossero in strada.

**Quarantotto anni di polemica si sono appoggiati su evidenze prive di potere discriminante.** È il primo referto di questo libro, e vale contro tutti.

---

## 5. I cinquantacinque giorni, e le parole di un uomo che scriveva

Dal 16 marzo al 9 maggio, Aldo Moro fu tenuto prigioniero nel covo di **via Montalcini 8**, appartamento acquistato nel **giugno 1977** — cioè **nove mesi prima dell'agguato**. La predisposizione della prigione **precedette** il sequestro. È uno dei dati più solidi e più agghiaccianti del giudicato.

In quei cinquantacinque giorni Moro scrisse. Lettere alla famiglia, ai colleghi di partito, alle istituzioni. Sono il documento più straziante del caso e il più contestato, e la ragione della contestazione è una perizia: **le lettere furono dichiarate non espressione autentica della sua volontà** — l'uomo che le scriveva sarebbe stato, secondo quella lettura, in uno stato che ne alterava la capacità di determinarsi.

Qui il libro deve fermarsi, perché è il punto in cui il suo oggetto e la sua forma coincidono.

Una perizia che dichiara non autentiche le parole di un uomo vivo, prigioniero e in pericolo di morte compie — quali che fossero le intenzioni di chi la firmò — un'operazione precisa: **toglie a un uomo la propria voce mentre è ancora in grado di usarla**. Da quel momento ogni sua frase può essere letta come non sua. Chi voleva trattare poteva citarlo; chi non voleva trattare poteva dire che non era lui a parlare. Il prigioniero perde la sola cosa che gli restava: la possibilità di essere creduto.

**È per questo che questo libro non è scritto nella voce di Aldo Moro.** Un'opera nata per distinguere ciò che un uomo ha detto da ciò che gli è stato attribuito non può, all'ultima pagina, attribuirgli parole. Chi gli mettesse in bocca un'ultima pagina ripeterebbe l'operazione — con l'aggravante della buona intenzione.

*C'è una crudeltà che non lascia lividi*
*e si esercita sulle frasi:*
*consiste nel dire, di un uomo che parla, che non è lui a parlare.*
*Dopo, si può fare qualunque cosa del suo silenzio,*
*perché il silenzio è già stato dichiarato suo.*

---

## 6. Il 9 maggio, e la fine della macchina materiale

Il 9 maggio 1978 il corpo di Aldo Moro fu ritrovato a Roma nel bagagliaio di una Renault 4. La direzione dell'operazione e l'esecuzione materiale dell'omicidio sono state accertate in via definitiva a carico di **Mario Moretti**, per sua stessa ammissione **recepita dal giudicato**.

Le due metà di quella formula contano entrambe. L'ammissione, da sola, sarebbe una fonte — autorevole, ma della stessa natura di ogni memoria di parte. È il **recepimento in sentenza definitiva** che la trasforma in fatto accertato. Il grado A non nasce dal fatto che Moretti l'abbia detto: nasce dal fatto che i giudici, vagliandola, l'abbiano fatta propria.
...
Su ciò che accadde in quei novanta secondi esiste un giudicato. E accanto al giudicato esiste **la questione più contestata dell'intero caso: le cosiddette *terze presenze*** — le persone che, secondo alcune testimonianze e alcune acquisizioni parlamentari, si sarebbero trovate in via Fani quella mattina senza appartenere al commando accertato.

Nella graduatoria delle piste, **le terze presenze non attribuite stanno in testa, con l'indice più alto di tutti**. Non perché siano la pista più suggestiva: **perché sono quella in cui il rapporto fra ciò che si potrebbe sapere e ciò che si sa è più squilibrato** — e, come si vedrà, quella in cui **gli atti per colmare lo squilibrio sono già stati disposti**.

E una disciplina, che in nessun altro punto del caso è così tentata di essere violata: **nessun reperto ha, in queste pagine, un nome come risposta attesa.** Le ipotesi riguardano *quante armi, quanti mezzi, quanti uomini* — **non chi**.

### Quattro ipotesi, undici evidenze

Sulla composizione di chi agì le ipotesi possibili sono quattro, e coprono l'intero campo escludendosi a vicenda.

**F1**, *organico coincidente*: l'insieme di chi agì coincide con il commando accertato, e nessuna presenza estranea vi si aggiunge. **F2**, *presenze estranee non operative*: una o più persone estranee erano presenti in funzione di osservazione, copertura o collegamento, senza partecipare all'azione di fuoco. **F3**, *presenze estranee operative*: almeno una persona estranea partecipò, con un'arma o con un mezzo. **F4**, *presenze percepite e inesistenti*: le due moto e il quarto uomo come prodotto di errori testimoniali e ricostruttivi su elementi reali ma diversamente spiegabili.

**F1 e F4 non sono la stessa ipotesi**, ed è un equivoco frequente. La prima afferma che nessun estraneo c'era, e con questo ha finito; **la seconda spiega *perché* qualcuno credette di vederli**, ed è la sola delle due che debba rendere conto delle testimonianze invece di ignorarle. **Chi liquida le terze presenze come suggestione sta in realtà sostenendo F4, non F1** — e F4 ha oneri propri.

Contro le quattro ipotesi la matrice schiera **undici evidenze**, e la loro gradazione è metà del lavoro.

**E1**, il giudicato stesso: l'organico del commando accertato in via definitiva. Grado **A**, l'unico della tavola.

I fatti balistici. **E2**: la perizia del 1978 — collegio **Ugolini-Iadevito-Lopez** — stabilì che furono esplosi **almeno 91 colpi da sei armi**, quattro mitra e due pistole. **B**. **E3**: **49 bossoli** attribuiti a un solo mitra, un **FNAB-43**, attribuzione **confermata** dall'esame del Servizio Polizia scientifica illustrato alla Commissione il **10 giugno 2015**. **B**. **E4**: l'attribuzione dei **22 colpi** al secondo mitra, già in dubbio nella perizia del 1993, **declassata a esito non conclusivo** dal medesimo esame del 2015. **B**. **E5**: la ricostruzione della dinamica **contraddice** la figura di un unico «superkiller». **B**.

Le acquisizioni testimoniali recenti. **E6**: la Commissione ha ritenuto **da approfondire** la presenza di **due motociclette** — non una — **con quattro persone a bordo**: una in fuga verso via Stresa, l'altra attardata sul luogo. **B**, con qualificazione da scrivere accanto e non in nota: **acquisizione parlamentare, non giudicato**. **E7**: **due testimoni oculari mai sentiti prima in quarant'anni** sono stati auditi — un residente di via Fani, e un ingegnere che riferì di una motocicletta Honda e di colpi esplosi nella sua direzione. **B**.

Le due che danno il titolo al capitolo, e che non portano un grado ma **un punto interrogativo**. **E8**: i **profili genetici** estratti nel 2016 dai mozziconi repertati nell'auto di sbarramento e nella base di via Gradoli restano, allo stato, **senza attribuzione pubblica**. **E9**: il **caricatore** repertato all'angolo fra via Fani e via Stresa **non fu mai sottoposto a comparazione in quarantotto anni**; nuovi esami sono stati disposti dal giudice.

E due Stati Zero. **E10**: quarant'anni di perizie e comparazioni **non hanno conseguito identificazioni di estranei** — esito negativo di robustezza **media**. **E11**: **nessun arco di collusione è mai stato provato** fra l'organizzazione che rivendicò ed eseguì il sequestro e soggetti di altri mondi — fra gli Stati Zero del caso, **uno dei più solidi**.

### La firma balistica e la sua tenuta

Il patrimonio balistico è **il materiale tecnico più solido dell'intero caso**: periziato nel 1978, messo in discussione in un punto nel 1993, riesaminato nel 2015. L'attribuzione dei quarantanove colpi a una sola arma — **la firma balistica dell'agguato** — è uscita dall'esame del 2015 **confermata**. Dove la firma non ha tenuto è sul secondo mitra: i ventidue colpi, dubbi già nel 1993, sono oggi ufficialmente **non conclusivi**.

Il riesame ha agito **nelle due direzioni** — ha confermato un'attribuzione e ne ha declassata un'altra. **È il comportamento che ci si aspetta da un esame vero**, ed è la ragione per cui questo libro ne accoglie gli esiti al medesimo grado in entrambe le direzioni, **senza scegliere quale dei due gli convenga**.

E qui la matrice produce **il suo primo risultato, il più istruttivo del capitolo: cinque evidenze su undici si cancellano.** E1, E2, E3, E4 ed E5 — **il giudicato e l'intero apparato balistico** — sono compatibili con tutte e quattro le ipotesi. Sono esattamente i fatti che il dibattito pubblico adopera da decenni in entrambe le direzioni, **e la tavola mostra perché entrambe le direzioni possano adoperarli: non discriminano. Un'evidenza compatibile con tutto non sostiene niente.**

Il caso più istruttivo è **E4**, i ventidue colpi declassati. Vengono citati come indizio di un'arma in più e dunque di un uomo in più. **Ma «attribuzione non conclusiva» non significa attribuzione a un altro: significa che l'esame *non decide*.** Un esito non conclusivo è compatibile con l'ipotesi che l'arma fosse del commando **e** con l'ipotesi che non lo fosse — **è, alla lettera, l'assenza di informazione. Adoperarlo come indizio è trasformare un silenzio in una voce.** E lo stesso errore, in direzione opposta, si commette con E3 ed E5: **che un'arma abbia sparato molto non dice nulla su quante altre persone fossero in strada.**

**È il risultato da portarsi via, ed è scomodo per tutti: l'intero apparato balistico ereditato dal 1978 non ha mai discriminato fra le quattro ipotesi in campo, e i quarantott'anni di polemica che vi si sono appoggiati hanno discusso di evidenze prive di potere discriminante. Da una parte e dall'altra.**

Che cosa discrimina, allora? Restano quattro righe.

**E6 ed E7 — le due moto e i due testimoni — sono incompatibili con F1**, e sono l'unica ragione per cui F1 non è oggi la sola ipotesi in tavola. Il loro grado va tenuto fermo in entrambe le direzioni: **non è giudicato** — nessuna sentenza ha stabilito che vi fossero due motociclette con quattro centauri estranei, e la Commissione parla di elementi *da approfondire*; **ma non è fantasia** — sono testimonianze oculari raccolte da un organo dello Stato sotto giuramento, e la loro esistenza è essa stessa un fatto. **Chi le eleva a prova sale di grado indebitamente; chi le liquida con un'alzata di spalle scende di grado altrettanto indebitamente.**

**E10 — nessuna identificazione di estranei in quarant'anni — è incompatibile con F3**, ed è la sola incompatibilità di cui F3 soffra. Stato Zero di robustezza **media**, e la misura va spiegata: se un estraneo avesse effettivamente partecipato con un'arma o con un mezzo, **una traccia sarebbe stata probabile ma non certa**; l'esito negativo deprime l'ipotesi in misura media, non la chiude. È la grammatica degli Stati Zero: **un'assenza vale quanto vale la probabilità che, se la cosa cercata fosse esistita, la si sarebbe trovata.**

**F2 e F4 non urtano contro nulla.** F2 spiega le testimonianze senza richiedere un'arma in più, e per questo non incontra E10. F4 le spiega **come testimonianze, cioè come ciò che sono**: resoconti umani di novanta secondi di fuoco. **Nessuna delle due è sostenuta da alcunché; nessuna è contraddetta da alcunché.** E vale la regola generale: **un'ipotesi che non paga prezzi non guadagna nulla dal non pagarli.**

Resta **E11**, che discrimina meno di quanto la sua solidità farebbe pensare: **neutro** rispetto all'ipotesi operativa, compatibile con tutte le altre. Solida com'è, **non decide**, e la disciplina impedisce di spenderla in una direzione o nell'altra.
...
F2 e F4: **non contraddette e non sostenute** — e F4, l'ipotesi che il dibattito pubblico non considera mai, **sta in tavola con pieno diritto e nessuna ragione di essere scartata**. F3: una sola incompatibilità, di robustezza media — **è l'ipotesi che le due celle non lette possono promuovere o affondare**, la sola posta davvero in gioco. E **F1 chiude l'ordine con *due* incompatibilità, il massimo della tavola**.

Quest'ultima riga contiene l'insegnamento dell'intera matrice, **ed è scomodo per entrambe le parti**. Le due incompatibilità **non indeboliscono F1 come ricostruzione giudiziaria**: un giudicato accerta responsabilità, non censisce presenze, e nessuna delle due tocca ciò che le sentenze hanno stabilito. **Ma segnalano con precisione dove il giudicato e le acquisizioni parlamentari non si sovrappongono.** Chi difende la ricostruzione giudiziaria deve accettare che essa porti due incompatibilità con acquisizioni raccolte sotto giuramento da un organo dello Stato, **e che l'unico modo di scioglierle sia una perizia, non un'alzata di spalle**. Chi sostiene le presenze estranee deve accettare l'altra metà del conto: **l'ipotesi operativa — la sola interessante, la sola che cambierebbe il racconto del caso — è anche l'unica che urta contro un esito negativo; e tutto l'apparato balistico che viene invocato per sostenerla non la sostiene. F2 e F4, che nessuno difende, stanno in tavola meglio di lei.**

### Le due celle non lette: il caricatore e i profili del 2016

Due celle portano il punto interrogativo, e la prima cosa da capire è **perché** sono vuote. **Non mancano i reperti: manca la lettura.** E la lettura **è già disposta** — nuovi esami sul caricatore ordinati dal giudice, comparazioni genetiche autorizzate alla Procura. Ne discende la differenza che conta: **la matrice di via Fani non chiede un atto nuovo. Chiede l'esito di atti già in corso.**

**Il caricatore ha una scheda**: è un **caricatore LMP da 40 colpi, con 25 cartucce calibro 9 Parabellum ancora inserite**, repertato all'angolo fra via Fani e via Stresa. E la ragione per cui restò quarantott'anni senza esami è agli atti, formulata con una franchezza che dispensa dal commento: **«si è dato per buono che fosse di Morucci perché ha raccontato di aver agito in quel punto, e nessuno ha mai voluto verificarlo».**

**Un reperto d'arma dell'agguato più esaminato della storia repubblicana è rimasto fuori da ogni comparazione per mezzo secolo perché una dichiarazione lo aveva già spiegato, e nessuno ha voluto misurare la spiegazione.**

Ora la misura è stata disposta. Il giudice per le indagini preliminari — su istanza degli avvocati **Nicola Brigida** e **Guido Salvini** per i figli di **Domenico Ricci** — ha ordinato gli accertamenti balistici sulla corrispondenza fra colpi e armi, **la ricerca di impronte papillari sul caricatore**, e il confronto delle tracce con gli autori già noti **e con ulteriori soggetti in banca dati**. L'esito non risulta ancora pubblico.

C'è, in questa vicenda, un dettaglio di metodo. **Il quesito che la matrice aveva isolato come il più efficiente del caso è esattamente il quesito che il giudice ha disposto**: scritto, questa volta, da chi ha titolo a scriverlo. *Non capita spesso che un'analisi trovi la propria domanda già formulata in un atto; quando capita, all'analisi non resta che la cosa più difficile — aspettare la risposta senza anticiparla.*

Il quesito del caricatore è **binario**, e per questo è il più efficiente dell'intero caso. **O** le tracce riconducono al commando accertato — **e allora F3 perde la sua unica via di ingresso materiale**; **o** riconducono a un ignoto — **e allora si apre un'identificazione giudiziaria**. *Un solo reperto, due esiti, nessuna zona grigia.* È la ragione per cui, nella graduatoria delle piste, questa ha un punteggio alto pur avendo un rendimento atteso minore di altre: **la sua diagnosticità è quasi perfetta. Non è la domanda che promette di più; è la domanda che, comunque risponda, decide.**

**I profili genetici del 2016** furono estratti dai mozziconi di sigaretta repertati nell'auto usata per lo sbarramento e nella base di via Gradoli. La comparazione è stata autorizzata dal giudice su una rosa di ex appartenenti all'organizzazione; la stampa qualificata riferisce che fra i soggetti richiesti del prelievo figurano **Giovanni Senzani** e **Paolo Baschieri**, e riferisce **il rifiuto opposto da Senzani e da Barbara Balzerani**.

E qui la disciplina va scolpita prima che qualcuno la dimentichi, **perché è esattamente il punto in cui il caso Moro ha prodotto negli anni le sue inferenze peggiori. Rifiutare un prelievo è un diritto, e non prova nulla.** Le persone appena nominate compaiono in queste pagine **per il fatto pubblico della richiesta e della risposta — nient'altro**; chi traesse dal rifiuto un'inferenza di colpevolezza **starebbe facendo ciò che quest'opera vieta a sé stessa e contesta agli altri**. I profili restano, allo stato, senza attribuzione pubblica: **questo è il dato, e il dato è tutto.**

Un vincolo per il futuro prossimo, da scrivere adesso, prima che gli esiti arrivino. **La rosa comparativa può essere allargata, ed è ragionevole che lo sia; ma l'allargamento dev'essere ragionato e dichiarato *prima*. Una rosa scelta dopo aver visto i profili non è una comparazione: è una conferma cercata.** Vale per la genetica ciò che vale per ogni tavola: **gli esiti accettabili si scrivono prima dell'esame, o l'esame non vincola nessuno.**

**Che cosa chiuderebbe la matrice.** Cinque atti, in ordine di rapporto fra potere discriminante e costo.

**Primo, il caricatore**: impronte e tracce genetiche, comparazione con la rosa autorizzata — quesito binario, reperto singolo, esito non ambiguo, **e già disposto**. **Secondo, i profili del 2016**: l'esito delle comparazioni, con la rosa allargata secondo la disciplina appena detta. **Terzo, l'anagrafe della moto**: immatricolazioni, furti e rinvenimenti del 1978, e la tavola delle motociclette sequestrate nei procedimenti collegati. È il quesito che discrimina fra F2/F3 e F4 — **una moto è un oggetto con un numero, e si lavora ad anagrafe, non a suggestione**.

**Quarto, la ri-escussione conservativa dei testimoni**, con protocolli di memoria assistita, **e prima che il tempo la renda impossibile**. Merita una riga in più perché **è la sola voce di questa lista che si chiude da sola se non la si apre**: reperti e archivi aspettano, **la memoria dei testimoni no**. Due di quei testimoni sono stati ascoltati per la prima volta dopo quarant'anni. **Quinto, l'esemplare dell'arma**: il censimento degli FNAB-43 sequestrati in Italia in cinquant'anni e la comparazione di ciascuno coi bossoli di via Fani. Se l'arma prevalente fosse identificata **come oggetto fisico**, sarebbe l'evidenza discriminante capitale; **ma è il bersaglio più ambizioso e meno probabile — quello dal quale è prudente attendersi di meno.**

*La terza cella aperta del caso non sta in via Fani ma sugli abiti: la sabbia, il suo orologio stagionale del 1978 e il quesito che in quarantotto anni nessuno ha mai posto. Ha una sua sede in questo libro, nel Libro settimo, e vi si legge per intero.*

E quando gli esiti arriveranno, **questa tavola dice già che cosa dovrà cambiare** — quale riga si cancella, quale ipotesi cade, quale resta in piedi. Se il caricatore torna al commando accertato, **F3 perde la sua unica via d'ingresso materiale**, e le due moto restano ciò che sono: acquisizioni da approfondire, che F2 e F4 spiegano senza costi. Se torna a un ignoto, **si apre un'identificazione giudiziaria, e sarà il giudice — non questo libro — a darle un seguito**. In entrambi i casi **gli assolti restano assolti, i prosciolti restano prosciolti, e nessun nome comparirà come responsabile fuori da un giudicato**: la tavola ordina ipotesi su *quanti*, e i *chi* appartengono ad altre sedi.
...
## Referto del Libro primo

**Oggetto.** Azione di fuoco del 16 marzo 1978, via Mario Fani angolo via Stresa, Roma; prigionia dal 16 marzo al 9 maggio 1978, via Montalcini 8; decesso di Aldo Moro il 9 maggio 1978.

**Vittime.** Sei. Leonardi (52), Ricci (43), Rivera (24), Zizzi (30), Iozzino (25), Moro (61). Il giudicato le tiene unite in un solo fatto criminoso.

**Elementi materiali accertati.** Almeno 91 colpi da sei armi (B); 49 bossoli a una sola arma, FNAB-43, attribuzione confermata nel 2015 (B); 22 colpi a esito non conclusivo dal 2015 (B); esclusione della figura del «superkiller» unico (B); acquisto della prigione nel giugno 1977, nove mesi prima dell'agguato (A).

**Responsabilità.** Tredici, personali, accertate in via definitiva fra il 1985 e il 1999 attraverso cinque processi. Oltre queste, nessun nome. Gli assolti restano assolti: l'assoluzione definitiva di **Rita Algranati** per i fatti di via Fani, pronunciata in primo grado nell'ottobre 1988, resta assoluzione anche contro ricostruzioni successive di grado inferiore.

**Elementi discriminanti.** Due soltanto, entrambi di grado B e di provenienza parlamentare: le due motociclette da approfondire e i due testimoni auditi dopo quarant'anni. Entrambi incompatibili con l'ipotesi F1.

**Elementi non discriminanti.** L'intero apparato balistico. Compatibile con tutte e quattro le ipotesi in campo, e dunque **inutilizzabile in entrambe le direzioni** — contro la ricostruzione giudiziaria come a suo sostegno.

**Celle non lette rilevanti.** Il caricatore repertato all'angolo via Fani/via Stresa, mai sottoposto a comparazione in quarantotto anni, con nuovi esami disposti. I profili genetici estratti nel 2016 dai mozziconi repertati nell'auto di sbarramento e nella base di via Gradoli, allo stato senza attribuzione pubblica.

**Conclusione del referto.** La macchina materiale è **descritta**, non spiegata; e la parte di essa che il dibattito pubblico discute da mezzo secolo è la parte che, tecnicamente, **non decide niente**. Questo referto non nomina alcun responsabile oltre i tredici del giudicato, e non lo farà in nessuna delle pagine che seguono.

---

# Libro secondo · La macchina che fabbrica in quarantotto anni

*La seconda macchina non ha bisogno di armi.*
*Ha bisogno di due nomi e di una congiunzione,*
*e la congiunzione fa tutto il lavoro:*
*«e» non dice niente, e per questo può dire qualunque cosa.*

*Funziona anche a vuoto. È la sua proprietà più preoccupante.*
*Una macchina che uccide, se non c'è nessuno da uccidere, si ferma.*
*Una macchina che fabbrica, se non c'è niente da spiegare,*
*spiega lo stesso — e il prodotto è indistinguibile dall'altro.*

---

## 7. Anatomia di una fabbricazione

Cominciamo dal pezzo più piccolo, perché tutte le macchine si capiscono dal pezzo più piccolo.

Il pezzo più piccolo è **una cifra fra parentesi**.

Nessun oggetto della storia repubblicana viene citato con più sicurezza e con meno verifica dei **numeri di tessera della loggia P2**. Compaiono ovunque, accanto a nomi di generali, ministri, banchieri, giornalisti. Hanno l'aria del dato d'archivio. E conferiscono a chi li scrive quell'autorevolezza tipografica che le cifre danno gratis.

Questo corpus ne ha presi **trentatré** e ha provato a certificarli. L'esito sta in una riga: **nessuno dei trentatré è certificabile. Non uno.**

La distinzione che regge tutto è fra *verificare* e *certificare*. **Verificare** è confrontare un'affermazione con le fonti raggiungibili, assegnarle un grado, registrare per iscritto anche l'esito negativo. **Certificare** è attestare che la cifra scritta accanto a un nome è **la cifra che sta in un campo determinato del documento sequestrato**, chiamandolo con il suo nome. Richiede tre cose: **il documento, l'intestazione della colonna, la riga letta per intero.** Nessuna delle tre è stata avuta.

E il risultato più solido della verifica è anche il più semplice, e demolisce da solo migliaia di note a piè di pagina: **la cifra fra parentesi non è, in generale, un numero di tessera**. È un numero di posizione in un elenco. Chi la scrive come tessera sta compiendo un'attribuzione documentale che nessuno gli ha autorizzato.

Su trentatré nomi, la ricerca indipendente ha trovato **appartenenza documentata da fonti indipendenti per ventotto**, **una posizione contestata in sede giudiziaria**, **quattro appartenenze non trovate**. *L'appartenenza, dunque, in larga parte regge. È il campo dei numeri che cede.*

Osservate il meccanismo, perché si ripeterà identico per il resto del libro:

1. Un fatto vero e verificabile — un'appartenenza documentata.
2. Un dato accessorio, apparentemente tecnico — una cifra.
3. La cifra **eredita l'autorevolezza del fatto** a cui è appiccicata.
4. La cifra circola da sola, e ora è il fatto ad ereditare autorevolezza da lei.

**Al passo 4 la macchina è a regime.** Non ha aggiunto una sola informazione al passo 1; ha aggiunto **una superficie di certezza**, ed è quello che serve.

---

## 8. La regola dell'anello più debole, e quella che tutti dimenticano

La macchina che fabbrica produce **catene**: sequenze di nomi legati da congiunzioni. E le catene si smontano con due regole, di cui la prima è nota e la seconda quasi mai.

**Prima regola: il grado di una catena è il grado del suo anello più debole.** Se quattro anelli su cinque sono di grado B e uno è di grado C, la catena vale C. Non vale «quasi B». Non vale «B con una riserva». Vale **C**, perché una conclusione non può essere più solida della più fragile delle premesse su cui poggia.

**Seconda regola, che è quella dimenticata: la tenuta di una catena è la tenuta della sua giuntura peggiore.** Gli anelli possono essere tutti eccellenti e la catena rompersi lo stesso — **fra** un anello e l'altro. Perché l'esistenza di A e l'esistenza di B non producono l'esistenza di *A→B*: la giuntura è un'affermazione a sé, e va provata a sé.

È la differenza fra un errore di *qualità* e un errore di *struttura*. Le catene che questo corpus ha smontato si sono rotte, quasi tutte, alla giuntura — cioè nel punto in cui nessuno guardava, perché tutti erano occupati a verificare gli anelli.

Aggiungiamo un terzo strumento, il più banale e il più letale:

**Il calendario va applicato a ogni anello, non alla catena.** Una catena si può datare in blocco e sembrare coerente; datata anello per anello, si scopre che due dei suoi elementi non erano contemporanei — e che uno dei due era **morto** quando l'altro accadde.

---

## 9. Quando il nome diventa una sigla

C'è un passaggio in cui la macchina che fabbrica compie la sua trasformazione più efficiente, e il caso Moro ne offre l'esempio da manuale — ma vale ovunque.

Un uomo si chiama **Roy Cohn**. È un avvocato di New York, ha una biografia documentata, dei clienti, delle date, e **muore il 2 agosto 1986**.

Poi «Roy Cohn» smette di essere un uomo e diventa **un'etichetta**: il nome per una certa maniera di fare le cose. E l'etichetta non muore. Continua a lavorare.

Questo corpus ha misurato la cosa. Una catena costruita da altri, **Cohn → Trump → Mosca**, si presentava con **ventun sezioni di documentazione**. Passate al calendario, anello per anello: **sei cadono dentro la sua vita, due la attraversano, una è cornice — e dodici sono interamente postume.**

**Non è un difetto di prove: è un difetto di anagrafe.**

E la cosa si è ripetuta in piccolo, con una precisione quasi comica. Cohn redasse un accordo prematrimoniale nel 1977. Gli accordi, però, non furono uno: furono **quattro o cinque**, rinegoziati nel 1979, nel 1984 e nel **1987**. Di quattro contratti Cohn può averne scritti al più tre: **il quarto è posteriore alla sua morte.** Attribuirgli «il» prematrimoniale è, alla lettera, sbagliato — e nessuno di quelli che lo scrivono ha mai commesso una menzogna: hanno solo omesso di aprire un calendario.

*Questa è la firma della seconda macchina.*
*Non mente. Non ne ha bisogno.*
*Prende una cosa vera, le toglie la data,*
*e la lascia libera di stare dovunque serva.*

---

## 10. La giuntura che si spara addosso

Il caso più istruttivo che questo corpus abbia smontato non si rompe per un calendario. Si rompe per una ragione che nessuno aveva previsto, e che vale la pena raccontare per esteso perché è un piccolo capolavoro involontario.

La catena diceva: **Gaetano Badalamenti → le Cinque Famiglie di New York → Roy Cohn → Donald Trump.**

Tre anelli. E — questo va detto subito, perché è il punto — **i tre anelli esistono tutti, e reggono tutti, e valgono tutti C.** Badalamenti aveva un tramite nella famiglia Bonanno. Cohn ebbe fra i clienti uomini di vertice di quelle famiglie. Cohn fu l'avvocato di Trump dal 1973. Nessuno di questi tre enunciati è falso.

**La catena si rompe alla giuntura, e in un modo che nessuno si aspettava: al nodo Bonanno i due rami si stavano uccidendo.**

Il Bonanno di Cohn era **Carmine Galante**, ucciso a Brooklyn il **12 luglio 1979**. Il Bonanno di Badalamenti era **Salvatore Catalano** — e l'accusa federale, nella propria requisitoria d'apertura al processo *Pizza Connection*, sostenne che Catalano fosse stato coinvolto in quell'omicidio.

Non è che i due rami non si toccassero: **erano su lati opposti di un delitto.**

E la frattura si vede una seconda volta. L'**11 febbraio 1987**, mentre il processo era in corso, **Pietro Alfano** — nipote di Badalamenti e suo uomo in America — fu colpito a Manhattan e rimase paralizzato, per ritorsione.

Sotto un unico cognome di famiglia, in otto anni: **un morto da una parte e un paralizzato dall'altra.** Chiamare quel nodo «un anello» significa saldare due estremi che si sparavano addosso.

C'è poi l'elemento più semplice, e sfugge a tutti perché è geografico: **Badalamenti non era a New York.** Esiliato in Brasile dal 1978, arrestato a **Madrid l'8 aprile 1984**, mandava i propri uomini **in Illinois** — pizzerie in piccolissime città del Midwest, che giudicava più sicure. Negli Stati Uniti mise piede **da imputato, portato dalla polizia.**

**Un cognome di famiglia non è un indirizzo.** E l'appartenenza a un'organizzazione non è prova di condotta — nemmeno quando l'organizzazione è quella, nemmeno quando la condotta sarebbe verosimile. È la regola su cui questo intero corpus è costruito, e vale identica nei due sensi: contro chi la userebbe per accusare e contro chi la userebbe per assolvere.

---

## 11. L'inversione: quando la catena va nella direzione sbagliata

Una terza catena, tutta italiana, mostra un guasto ancora diverso — e più raro, perché non è una debolezza: è un **rovesciamento**.

La catena diceva: **Nuova Camorra Organizzata → banda della Magliana → Michele Senese → clan Spada → Casamonica.** Una genealogia della Roma criminale, ordinata, plausibile, largamente ripetuta.

**Si rompe due volte.**

La prima rottura è l'inversione. **Michele Senese non era della NCO.** Cominciò nel clan Moccia e nella **Nuova Famiglia** — il cartello costituito **contro** Raffaele Cutolo, con cui combatté la più sanguinosa guerra di camorra della storia repubblicana — e fu mandato a Roma per conto di quella. **Non porta la NCO nella capitale: vi porta i suoi nemici.** La freccia della catena, nel punto centrale, punta **all'indietro**.
...
Regge un solo segmento, ed è l'unico contemporaneo: **NCO – banda della Magliana**. Ma anche lì «contemporaneo e in contatto» non è «unito»: negli stessi anni la Magliana ha accanto **Pippo Calò**, terminale romano di Cosa Nostra — cioè una **terza** organizzazione ancora.
...
## 12. Le quattro regole che restano

Da tre catene smontate in tre modi diversi restano quattro regole, e sono il vero prodotto di questo libro secondo.
...
**Un avvocato in comune è un ponte fra fascicoli, non fra persone.** È il legame più facile da documentare e più facile da sopravvalutare, perché ha un'anagrafe, e un'anagrafe sembra una prova. La contro-prova è definitiva: applicata all'elenco dei clienti di un solo penalista di grido, quella logica metterebbe nella stessa rete **un capomafia siciliano e un gruppo della sinistra armata americana**. L'assurdità è la dimostrazione.

**Il calendario va applicato a ogni anello, non alla catena.**

**Una co-presenza è la definizione di un luogo, non l'indizio di un'organizzazione.** Su questa si tornerà nel Libro quinto, perché ha un caso che la prova.

---

## 13. Il caso in cui la macchina ha girato a vuoto, e si è vista

Il corpus ha condotto una campagna di cento blocchi su una figura — il cardinale **Francis Spellman** — nella convinzione che il suo nome fosse un nodo. Cento blocchi mirati, dieci strumenti indipendenti, un apparato di verificatori con il mandato esplicito di **declassare, mai promuovere**.

Esito: **zero blocchi di grado A. Zero blocchi di grado B.** Duecentonove correzioni imposte dai verificatori, **2,09 per blocco**.

E un risultato di merito che ha rovesciato la premessa: il lavoro legale per l'arcidiocesi, che la catena attribuiva a Cohn, era in realtà di **Thomas A. Bolan** — un altro uomo, un altro nome, un'altra biografia. La catena aveva scambiato **due soci di studio**.

Nemmeno la stima temporale reggeva. Una sovrapposizione «di tredici anni esatti» fra i due uomini, che chi scrive aveva calcolato e trovato elegante, è stata rotta da un controllo per **falsa precisione**: poggiava su una data non verificata. La finestra massima documentabile è **27 maggio 1948 – 2 dicembre 1967**, cioè **7.128 giorni**. Non tredici anni: un intervallo con due estremi e un numero.

**Il referto di quella campagna è il più utile dell'intera opera, e non contiene un solo fatto nuovo. Contiene la dimostrazione che la macchina che fabbrica funziona anche quando non c'è niente da spiegare** — perché ha continuato a produrre catene plausibili per cento blocchi, e ci sono voluti dieci strumenti indipendenti per stabilire che il nodo non c'era.
...
**Un capitolo assorbito, e va detto.** La narrazione di questo libro riprende per intero il capitolo *«Le catene che si spezzano, e dove esattamente»*, che ne riprende le tre catene con le stesse date e gli stessi nomi: nell'edizione ridotta esso si legge a sé, qui sarebbe una seconda lettura della stessa pagina. **Non è stato tagliato: è stato assorbito**, e ogni sua data, cifra e nome sta nelle pagine che precedono.

---

## 11. I numeri della P2: il residuo, e una distinzione che le sintesi non fanno

*Il Libro secondo ha già dato il conto — trentatré numeri, nessuno certificabile, ventotto appartenenze documentate da fonti indipendenti, una posizione contestata in sede giudiziaria, quattro non trovate, e l'accertamento che la cifra fra parentesi non è, in generale, un numero di tessera. Restano tre cose che quel conto non contiene.*

### Il limite della verifica, dichiarato prima dei risultati

La ricerca **esaurì il proprio accesso alla rete a metà corsa**: i primi gruppi di nomi furono verificati con accesso alle fonti; gli approfondimenti finali e **l'intera fase di refutazione** si svolsero senza poter aprire una sola fonte.

I refutatori restituirono «refutato» per ciascun numero, ma il motivo addotto era sempre lo stesso: *nessuna fonte consultata, nessuna consultabile*.

**Quelle refutazioni non sono prove contrarie: sono impossibilità di verificare.** Registrarle come riscontri negativi sarebbe esattamente l'errore che quest'opera esiste per non commettere — la conversione di un'ignoranza in un accertamento. **Il grado massimo attribuibile a qualunque affermazione su questi numeri è perciò C**, e lo è per una ragione che riguarda lo strumento e non l'oggetto.

### La distinzione che riguarda un nome ricorrente

Su uno dei quattro nomi la cui appartenenza non è stata trovata va ribadita una distinzione che le sintesi non fanno mai, e che nel caso Moro pesa:

> **la presenza in via Fani il 16 marzo è oggetto di accertamento documentato; l'appartenenza alla loggia non lo è.**

Sono **due affermazioni di rango diverso**, e vanno tenute separate anche — soprattutto — quando riguardano la stessa persona. Chi le fonde ottiene un enunciato che sembra doppiamente provato e non lo è per nessuna delle due metà.

### Che cosa regge, e che cosa cede

**L'appartenenza, in larga parte, regge. È il campo dei numeri che cede.**

La differenza fra **verificare** e **certificare** è tutta qui, e vale per qualunque cifra si legga in qualunque libro. Verificare è confrontare un'affermazione con le fonti raggiungibili, assegnarle un grado e registrare per iscritto anche l'esito negativo. Certificare è attestare che la cifra scritta accanto a un nome **è la cifra che sta in un campo determinato del documento sequestrato, chiamandolo con il suo nome** — e richiede tre cose: il documento, l'intestazione della colonna, la riga letta per intero.
...
**Reperto 1 — La cifra fra parentesi.** 33 numeri di tessera P2 sottoposti a certificazione: **zero certificabili**. Appartenenza documentata da fonti indipendenti per 28; una posizione contestata in sede giudiziaria; 4 non trovate. Accertamento di rango documentale: la cifra fra parentesi non è, in generale, un numero di tessera. **Grado massimo attribuibile a qualunque affermazione su quei numeri: C.**

**Reperto 2 — La catena postuma.** Catena Cohn→Trump→Mosca, 21 sezioni: 6 dentro la vita di Roy Cohn (†2 agosto 1986), 2 a cavallo, 1 cornice, **12 interamente postume**. Il prematrimoniale: 4-5 accordi, l'ultimo del 1987, **posteriore alla morte del redattore che gli viene attribuito**.

**Reperto 3 — La giuntura ostile.** Catena Badalamenti→Cinque Famiglie→Cohn→Trump: tre anelli esistenti, tutti di grado C, **giuntura rotta al nodo Bonanno** — Galante ucciso il 12 luglio 1979; Catalano indicato dall'accusa federale come coinvolto in quell'omicidio; Alfano colpito e paralizzato a Manhattan l'11 febbraio 1987. Elemento geografico dirimente: Badalamenti mai operativo a New York; esiliato in Brasile dal 1978, arrestato a Madrid l'8 aprile 1984.

**Reperto 4 — L'inversione e l'anacronismo.** Catena NCO→Magliana→Senese→Spada→Casamonica: Senese proveniente dalla **Nuova Famiglia**, cartello costituito *contro* la NCO — freccia invertita; riconoscimento del clan Spada come associazione di tipo mafioso nel 2019-2021, **trentacinque anni dopo** la distruzione giudiziaria della NCO. Unico segmento contemporaneo: NCO–Magliana, con presenza simultanea di un terzo terminale (Calò).

**Reperto 5 — La macchina a vuoto.** Campagna Spellman: 100 blocchi, 10 strumenti indipendenti, **0 A, 0 B**, 209 correzioni (2,09/blocco). Errore di merito accertato: attribuzione a Cohn di lavoro legale riferibile a **Thomas A. Bolan**. Errore metrico accertato a carico di chi scrive: falsa precisione su una sovrapposizione temporale; finestra massima documentabile 27.05.1948–02.12.1967, **7.128 giorni**.

**Conclusione del referto.** La macchina che fabbrica non richiede menzogna, dolo né coordinamento. Le richiedono soltanto **due nomi veri e l'omissione di una data**. Il suo prodotto è formalmente indistinguibile da una scoperta, e la distinzione non si ottiene leggendo il prodotto: si ottiene **applicandogli un calendario e chiedendo alla giuntura di provarsi da sé**. Nessun nome è, in questo referto, indicato come responsabile di alcunché.

---

# Libro terzo · Gli strumenti, e il giorno in cui si sono rotti

*Chi costruisce uno strumento per misurare gli altri*
*costruisce, senza volerlo, uno strumento che misurerà lui.*
*È l'unico modo in cui uno strumento sia onesto,*
*e nessuno lo desidera davvero.*

*Questo libro racconta gli strumenti di quest'opera*
*e poi racconta, con i numeri, dove hanno sbagliato.*
*La seconda parte è più corta della prima e vale di più:*
*un metodo si giudica dai suoi errori dichiarati,*
*non dai suoi successi raccontati.*

---

## 14. I gradi non sono una scala di fiducia

È l'equivoco più diffuso su questo apparato, e va sciolto per primo perché tutto il resto ne dipende.

**I gradi di quest'opera non sono una scala di fiducia: sono una classificazione della specie della fonte.**

**A** non significa «molto probabile». Significa **giudicato definitivo**: un fatto accertato con sentenza penale passata in cosa giudicata, non più discutibile se non portando prove almeno pari a quelle su cui la sentenza si fonda.

**B** non significa «ben documentato». Significa che **un organo che accerta l'ha accertato**: commissioni d'inchiesta, atti istruttori, testimonianze qualificate. Serio, raccolto da organi dello Stato con poteri reali, e **privo di effetto penale** — perché una Commissione parlamentare non è un tribunale.

**C** è la congettura: l'ipotesi che spiega e non prova.

**F** è il fatto pubblico: la circostanza biografica o notoria che non attribuisce nulla a nessuno.

**Stato Zero** è l'assenza documentata, e la definiremo fra poco con la cura che merita.

Dalla natura di questa classificazione discende la conseguenza operativa: **un grado non si alza decidendolo. Si alza trovando il documento della specie superiore.** Nessuna quantità di grado B produce un grado A. Nessuna somma di congetture produce un accertamento. E — regola simmetrica, che vale contro chi scrive — **non si alza un grado per istruzione, nemmeno se l'istruzione viene dal titolare dell'opera.**

Il titolare, in un momento di comprensibile impazienza, chiese una volta di *«portare a livello A tutto ciò che è possibile portare da livello B, e da C a B il resto»*. La richiesta ha una sola esecuzione onesta, e questo corpus l'ha eseguita così: **un registro che, per ogni cella aperta, indica il documento che la promuoverebbe, la sede in cui sta, e se è raggiungibile.** Chi apre quelle sedi esegue la promozione; il registro gli dice dove andare.

Ne uscì una promozione legittima — le cifre di un'accademia, portate da C a F perché l'istituzione le dichiara di sé nelle proprie pagine ufficiali, e **una cifra che un'istituzione dichiara di sé è un fatto pubblico**. E ne uscì un rifiuto: il candidato più prezioso a una A — un processo il cui verdetto avrebbe trasformato un'imputazione in giudicato — fu interrogato e risultò **ancora in corso**. L'imputato resta presunto innocente; la cella resta aperta, ora con la data della verifica accanto.

**Non è stato alzato un grado: è stata aperta una fonte.** È l'unica forma di promozione che esista.

---

## 15. Le due parole che sembrano gemelle

Fra queste pagine ricorrono due formule che si somigliano e non hanno nulla in comune. Confonderle è l'errore più grave che si possa commettere in un lavoro come questo, perché trasforma **un'ignoranza in un accertamento**.
...
Un verificatore di quest'opera l'ha detto meglio di come si potrebbe riscriverlo, cancellando una categoria che un redattore aveva inventato per cavarsela — «Stato Zero debole»:
...
Uno Stato Zero, inoltre, **non vale sempre lo stesso**. Vale quanto vale la probabilità che, se la cosa cercata fosse esistita, la si sarebbe trovata. Se quella probabilità è schiacciante, l'assenza quasi chiude l'ipotesi; se è media, la carica di un onere e basta; se è trascurabile, l'assenza non dice nulla. **Un'assenza non è un fatto: è un fatto diviso per la sensibilità dello strumento che l'ha cercata.**

---

## 16. La matrice, e il risultato che si ripete

Lo strumento centrale di quest'opera non è un archivio: è una **tavola**.

Si costruisce così. Si elencano tutte le ipotesi possibili su una questione, in modo che si escludano a vicenda e coprano l'intero campo. Si elencano le evidenze disponibili, ciascuna col suo grado. Si incrocia ogni evidenza con ogni ipotesi e nella cella si mette un segno: **compatibile**, **incompatibile**, **neutro** — oppure il punto interrogativo della **cella non letta**, quando l'evidenza esiste ma il suo contenuto non è disponibile.

Poi si legge il conteggio. Ma si legge sapendo tre cose:

**Un'evidenza compatibile con un'ipotesi non la conferma.** Dice soltanto che non la contraddice.

**Un'ipotesi che non paga prezzi non guadagna nulla dal non pagarli.** L'ipotesi con zero incompatibilità non è la vincente: è quella che non ha ancora incontrato niente.

**Il conteggio non elegge un vincitore: misura quali ipotesi pagano prezzi e quali no.**

Applicata tre volte a tre questioni diverse del caso, questa tavola ha prodotto ogni volta lo stesso risultato, ed è il risultato più severo dell'opera intera:

**La maggior parte delle evidenze più discusse ha diagnosticità nulla. Ciò che discrimina è, ogni volta, poco, tecnico e ancora da leggere.**

L'apparato balistico di via Fani: compatibile con tutte e quattro le ipotesi. Il patrimonio delle omissioni istituzionali — il controllo fallito di via Gradoli, gli assetti dello stabile, la concentrazione delle indagini: quasi nulla di esso esclude alcuna delle quattro spiegazioni in campo. Su ogni tavola, cinque, sei, sette righe su undici **si cancellano**.

E l'evidenza che decide, quando c'è, è sempre una sola, sempre minuscola, e sempre **non ancora letta**.

---

## 17. La matrice delle omissioni: quattro spiegazioni in ordine di prezzo

Vale la pena mostrare una tavola per intero, perché è l'esempio in cui la disciplina pesa di più: la materia è la condotta di apparati dello Stato.

E qui la regola va scritta prima dei fatti. **Un'entità si indaga per i propri atti e le proprie omissioni documentati, mai come colpevole.** La responsabilità istituzionale **non si trasmette** alle persone che ne fecero parte. Le appartenenze individuali sono fatti documentati dove le commissioni le hanno accertate, e **restano fatti: non diventano condotte nel caso.** *Questa tavola non ha per esito un nome*, e chi la legge sperando che ne esca uno la sta leggendo per la ragione sbagliata.

Le spiegazioni possibili di ciò che non fu fatto sono quattro:

**O1 — inefficienza ordinaria.** Impreparazione, sovraccarico, difetti di coordinamento e di cultura investigativa.

**O2 — catena di comando interrotta di fatto.** Il collegamento fra autorità politica e apparato risultava, nella primavera del 1978, interrotto **in fatto**: non una regia, una discontinuità strutturale.

**O3 — omissione consapevole settoriale.** In uno o più punti determinati qualcuno si astenne **sapendo**, senza che ciò implichi un disegno complessivo.

**O4 — regia unitaria.** Le condotte ostruttive furono dirette da un centro.

Sono in ordine crescente di pretesa, e la forma è quella corretta: **ciascuna richiede tutto ciò che richiede la precedente, e qualcosa in più.** Chi sostiene O4 non sta sostenendo un'alternativa a O1: sta sostenendo O1 **più** una catena interrotta **più** una conoscenza **più** una direzione. **Ogni gradino va pagato separatamente.**

Le evidenze, coi loro gradi. Il **controllo fallito del 18 marzo 1978** (B): una squadra effettuò controlli nello stabile di via Gradoli 96; all'interno 11 — il covo — nessuno rispose e la squadra non entrò; un'informatrice aveva segnalato rumori sospetti; del fallimento le autorità si avvidero **soltanto dopo il 18 aprile**. Gli **assetti dello stabile** (B): dei sessantasei appartamenti, ventiquattro di società immobiliari i cui amministratori comprendevano fiduciari dei servizi. La **concentrazione al Viminale** (B), accertata dalla Commissione Anselmi, con menomazione dell'autonomia dell'autorità giudiziaria. La **composizione dei comitati** (F/B) — fatto accertato dalle commissioni, **che non è prova di alcuna condotta nel caso**. Il **dato accertato e non spiegato** (A quanto al fatto): un'organizzazione di poche decine di clandestini tenne in scacco il più imponente dispositivo di ricerca della storia repubblicana.

E due Stati Zero. **La ricerca di una regia unitaria dietro le condotte ostruttive non è mai approdata a un centro identificato.** **Nessuna informazione specifica preventiva è mai stata accertata**: le segnalazioni giunte erano valutazioni di rischio generiche, non notizie di un progetto in corso — Stato Zero di robustezza *media*.

Infine, la riga più eloquente, che viene da un'elaborazione topologica: **densità elevata** di relazioni fra politica, apparati, istituzioni, informazione e ambienti criminali; densità **pressoché nulla** fra ciascuno di essi e l'organizzazione armata, che nel grafo appare come **nodo isolato**, connesso al resto soltanto attraverso l'atto.

**Il risultato della tavola è che quasi nessuna di queste evidenze esclude alcunché.** Sono tutte documentate, alcune al rango più alto, e sono **quasi tutte compatibili con O1 come con O4**. Il che non significa che O4 sia falsa: significa che **i fatti con cui la si sostiene da quarant'anni non la sostengono**, e che chi vuole sostenerla deve pagare i gradini che ha saltato.

---

## 18. Dove gli strumenti si sono rotti

Ora la parte che vale di più.

**Il registro che contava ottanta celle, e ne aveva trentasei.** L'opera si era data una condizione di chiusura: ogni cella aperta deve portare una data di interrogazione. Un generatore contava le celle non interrogate e ne trovava **ottanta**. Erano **trentasei**. Fra le ottanta c'erano titoli di sezione — *«Le celle aperte, con sede»*, che ricorre in nove capitoli —, frasi di metodo, la dichiarazione di generazione automatica, e **una negazione contata al rovescio**: *«il solo blocco dell'intera opera che non ha celle aperte»*. Il registro stampava «sede non indicata» per settanta proposizioni su ottantuno **e non ne traeva la conseguenza**. **80 → 36**, col numero vecchio stampato accanto, sbarrato.

**Il contatore scritto a mano che aveva derivato.** L'opera ripeteva che il proprio risultato ricorrente era stato ottenuto N volte. **N era scritto a mano, in otto punti diversi**, e aveva derivato: *quinta conferma* in un capitolo, *sette prove* in quattro altri, *otto* in un sesto. Ciascun numero era esatto il giorno in cui fu scritto e ha smesso di esserlo il giorno dopo. **È un errore di contabilità, non di ricerca — e la cura di un errore di contabilità non è riscrivere i numeri: è smettere di scriverli a mano.**

**Tre gradi gonfiati.** **A → F in quattro punti**: la data di fondazione di un'associazione era registrata come A; una data di fondazione è un fatto pubblico. **B → C** su un'evasività istituzionale che nessun organo accertatore aveva accertato. **F → C** su una linea che otto strumenti indipendenti su dieci hanno chiesto di declassare.

**La misura che misurava se stessa.** Un controllo doveva stabilire quanto l'opera si citasse da sola. La prima espressione regolare contava come «interne» anche stringhe come *senate.gov* e *pbs.org*, perché contenevano un punto e tre lettere. Prima cifra: 38,4%. Poi una sottocifra ancora peggiore. Cifra corretta: **29,3%**. **Un'espressione regolare non è una lettura.**

**L'effetto dell'osservatore, due volte.** Il conteggio delle occorrenze di un nome nel corpus passò da 196 a 197 **perché chi scrive aveva modificato l'indice**. E una campagna intera fu costruita sulla premessa che un certo nome comparisse **zero** volte nel corpus: alla fine della campagna compariva **826** volte, e la causa era la campagna stessa. Lo stabilirono strumenti che citavano **due hash di commit diversi**.

**E l'errore peggiore, che è di specie.** Chi scrive dichiarò in un rapporto che un sintetizzatore *«non aveva completato il proprio giro»*. Aveva finito **quattro minuti dopo**. La correzione sta accanto all'errore, sbarrata, e la diagnosi onesta è questa: **ho tratto una conclusione sul mondo invece che sulla mia osservazione.** È lo stesso errore, in scala minima, che questo libro imputa a mezzo secolo di ricostruzioni.
...
**Un capitolo assorbito, e va detto.** La narrazione di questo libro riprende per intero il capitolo *«L'opera che corregge sé stessa, e che cosa le è costato»*, che ne riprende i sei guasti con le stesse misure: nell'edizione ridotta esso si legge a sé, qui sarebbe una seconda lettura della stessa pagina. **Non è stato tagliato: è stato assorbito**, e ogni sua data, cifra e nome sta nelle pagine che precedono.

---

## 13. Il metodo: la disciplina, e ciò che non si negozia

*Il Prologo ha dato la scala di triangolazione e il Libro terzo i gradi, le matrici e i loro guasti. Questo capitolo dà il resto della disciplina: da dove viene, quali tetti impone alle fonti, e le cinque regole che non ammettono eccezione perché non sono scelte di metodo ma limiti etici.*

Ogni libro sul caso Moro chiede al lettore, prima di cominciare, **un atto di fiducia**: credere che l'autore abbia pesato le fonti, distinto i fatti dalle voci, resistito alla tentazione di completare il quadro dove il quadro non si lascia completare. Questo chiede una cosa opposta: **chiede al lettore di non fidarsi, e gli consegna in cambio gli strumenti per controllare.**

### La disciplina, e il suo nome

Nel corpus la disciplina porta il nome che l'autore le ha dato: **il Pollo di Popper**. È il falsificazionismo applicato a un caso di storia repubblicana, e sta in quattro proposizioni. **Dove la fonte documenta, si certifica; dove la fonte tace, si indaga e non si afferma; la congettura non è vietata, è marcata; e ogni asserzione portante espone il proprio criterio di smentita** — perché un'affermazione che non può essere smentita da nulla non sta affermando nulla.
...
La scala funziona perché è governata da regole di conservazione. La prima è di equilibrio: **nessuna voce sale di grado per suggestione; nessuna scende per scetticismo di maniera.**

La seconda assegna a ciascuna specie di fonte **un tetto invalicabile**. Gli **atti giudiziari** accertano, e arrivano al grado **A**. Gli **atti parlamentari** documentano: tetto **B**. I **documenti desecretati** attestano ciò che dicono, con protocollo: tetto **B**. Gli **atti normativi e comunitari** fanno fede del testo: tetto **A/F**. La **memorialistica** è fonte di parte: tetto **C** salvo riscontri. La **pubblicistica** è indizio di piste, mai fonte di accertamento: tetto **C**.

Da qui i corollari applicati per tutto il libro: **la convergenza non si promuove mai a nesso; la contemporaneità non è nesso**; il registro cronologico dell'opera *«non stabilisce alcun nesso fra le date che elenca»*; **il doppio sospetto non è un grado di prova**; e i buchi documentali **si misurano, non si riempiono**.

E la distinzione da cui dipende il tetto delle carte desecretate: **fra il documento e il documentato**. Che una carta esista, e con un certo protocollo, è una cosa; **che ciò che essa racconta sia accaduto è un'altra**. È per questo che il loro tetto è B e non A.

**Un solo oggetto può attraversare più gradi**, e distinguere i piani è il mestiere della scala. Le lettere dalla prigionia sono **A** quanto a esistenza e mano, **B** quanto alle condizioni di scrittura. Il falso comunicato del lago della Duchessa è accertato come falso al grado **A**; la sua funzione — chi lo volle, e perché — resta **C**. Via Montalcini è l'unica prigione accertata; **ogni luogo ulteriore sta fra il C e lo Stato Zero**.

### Le cinque regole che non si negoziano

**Prima: il principio personalistico.** La Costituzione lo fissa all'articolo 27 — **la colpa non è mai del gruppo ed è sempre della persona**. Il registro del giudicato contiene **tredici nomi** — Moretti, Gallinari, Morucci, Faranda, Fiore, Bonisoli, Balzerani, Seghetti, Braghetti, Casimirri, Lojacono, Maccari, Etro — ciascuno con la propria condotta e la propria sentenza: **non un blocco, tredici posizioni distinte**. I trentadue ergastoli del cosiddetto processone **non si travasano nel caso**. Dentro il giudicato sta la direzione dell'operazione, accertata in capo a Moretti per ammissione recepita, e con essa l'autonomia decisionale dell'organizzazione quale i processi l'hanno stabilita; **oltre il giudicato non è accertato alcun mandante, e quest'opera non ne nomina**.

Al principio personalistico appartiene l'altra metà del registro, **quella che si scrive per prima**. In testa al repertorio, non in fondo, stanno le sei vittime: **Oreste Leonardi, Domenico Ricci, Giulio Rivera, Francesco Zizzi, Raffaele Iozzino** e **Aldo Moro**. I loro nomi vengono prima delle questioni aperte, prima delle piste, prima di ogni congettura, **perché il caso è anzitutto la loro morte**.

**Seconda: l'appartenenza non è condotta.** Che una persona abbia fatto parte di uno o più gruppi è un fatto biografico — grado **F** — e **un fatto biografico è inerte**. Allo stesso modo **la parentela non è canale e la contemporaneità non è nesso**. La prosopografia dei tredici condannati, incrociata con tutti gli altri domini del corpus, ha prodotto **otto ponti documentati, quattro esiti negativi e cinque anti-triangolazioni**, con una conclusione che è insieme un risultato e una regola: **nessun ponte è un nesso. Le biografie si toccano; le responsabilità no.**

**Terza: gli assolti restano assolti, i prosciolti restano prosciolti.** Il corpus mette al bando una figura retorica precisa, **il «fu assolto, ma»** — la formula con cui un'assoluzione viene pronunciata e subito erosa. Il banco di prova maggiore è il nodo Hyperion, e i proscioglimenti si scrivono in testa e non in coda: **Mulinaris fu assolto con formula piena e risarcito; Berio fu assolto due volte; Simioni non fu mai condannato.** Queste tre righe non sono una concessione: **sono l'esito giudiziario.** Chi cerca in queste pagine un'insinuazione che aggiri una sentenza non la troverà.

**Quarta: le divergenze si riportano, non si scelgono.** Quando le fonti confliggono, l'opera le espone fianco a fianco e dichiara **che cosa, se emergesse, deciderebbe fra loro** — ma non decide al posto dei documenti. Il corpus ha portato la regola alla forma estrema: un intero libro di **1.025 studi sincronici** che sugli stessi soggetti pone fianco a fianco la pista assodata e la sua speculare, con la colonna speculare sviluppata nel modo più forte che le fonti consentano, **senza mai cedere sul grado** — e con la verifica, non la sola dichiarazione, che **su tutta la linea nessuna colonna speculare raggiunge mai il grado A**.

**E la divergenza più importante attraversa l'opera stessa**, ed è dichiarata in testa come costitutiva. Il Dossier maggiore dell'autore, nella sua quinta e ultima Fase, **congeda il Pollo di Popper e adotta il giudizio probabilistico** su architetti, mandanti ed esecutori, fino a una graduatoria costruita secondo dieci metodi. **Il versante pubblico del corpus — quello da cui questo libro è ricavato — non riproduce quel congedo**: la sua Fase quinta si ferma dove si ferma il giudicato, gli esecutori sono i tredici del registro, i piani superiori restano al grado che le prove consentono. Il lettore che voglia l'esercizio probabilistico **sa che esso esiste**, nell'edizione maggiore e sotto la responsabilità dell'autore.

**Quinta: le correzioni si annotano accanto, mai in silenzio.** Un'opera che si corregge cancellando le proprie versioni precedenti chiede di nuovo quella fiducia cieca che il metodo esiste per rendere superflua. Gli esempi sono la storia del corpus. Quando furono rimossi dall'opera il saggio-cerniera «Dal Che a Moro» e la parabola di Ernesto Guevara in sei parti — **sette documenti**, col volume tematico che li rilegava — **i riferimenti a quei documenti non sono stati cancellati**: rinviano a testi che non ci sono più, ed è ciò che deve risultare a chi legge, **perché cancellarli avrebbe reso la rimozione invisibile**. Per la stessa ragione **la numerazione dei Libri non è stata rifatta, e dopo il Libro primo viene il Libro quarto**. Il libro dei mille studi paralleli riporta integralmente in coda il registro delle **190 correzioni** dei propri verificatori avversariali, con la critica di completezza. E la campagna di verifica del 31 agosto — **cinquantotto agenti su quattordici bersagli residui** — si è chiusa col risultato più istruttivo che una verifica possa dare: **nove bersagli su quattordici declassati**, quasi tutti per lo stesso motivo — *un grado B o F assegnato senza che alcuna fonte fosse stata davvero aperta*.

### Un'opera che dichiara sé stessa

Quest'opera è **generata da un'intelligenza artificiale**, su comando e responsabilità di un autore umano, e non lo nasconde.

Perché la dichiarazione è la prima pietra del metodo e non una nota legale? Perché **un'opera del genere non può chiedere la fiducia che si accorda a un testimone o all'autorità di uno studioso, e non deve chiederla. La sua sola moneta è la tracciabilità**: ogni affermazione col suo appoggio dichiarato, il suo grado, il suo criterio di smentita; ogni catena col suo anello debole in vista; ogni assenza con la sede dove cercare. **I gradi della prova sono, in questo senso, il sostituto dichiarato dell'autorità dell'autore.** Un'opera che nascondesse la propria origine chiederebbe un credito che non le spetta; **dichiarandola, converte quel credito in un onere** — l'onere di mostrare, riga per riga, su che cosa poggia.

Alla stessa esigenza risponde **il trattamento delle voci**. Il corpus contiene due esercizi di stile dichiarati — *pastiche* — in cui una voce è prestata ad Aldo Moro come a teatro: **non sono parole sue, non gli sono attribuibili, non contengono rivelazioni di fatto**, e vanno lette solo così. Il romanzo che dal corpus deriva parla in prosopopea dichiarata a ogni apertura di capitolo, con la voce prestata in corsivo e l'apparato dei gradi in tondo: **il lettore sa sempre chi parla**, e le affermazioni fattuali stanno tutte, e soltanto, nelle parti in prosa piana coi loro gradi. È la regola della dichiarazione d'origine applicata alla voce invece che alla mano: **nessuna parola finge di venire da dove non viene.**

E il perimetro: il materiale che tocca persone viventi con attribuzioni non riscontrate **resta riservato, fuori di qui**, e sotto la stessa disciplina. Queste pagine trattano soltanto storia documentata e pubblica.

### Il patto di lettura

Un esempio vero, sulla domanda più contestata del caso: *c'erano i margini per catturare Moro e portarlo in un luogo volutamente delle Brigate Rosse e non d'altri?* Il corpus la tratta come la disciplina impone — **non come tesi da rendere verosimile, ma come ipotesi da rendere falsificabile** — e risponde per gradi. **I margini esistono, sono uno solo — il percorso fra via Fani e via Montalcini, il solo segmento non coperto da corroborazione indipendente — e sono materialmente vuoti.** Che il luogo fosse volutamente delle BR **è giudicato**. Che altri lo volessero tale **è la sola parte priva di appoggi**, e la si tiene aperta *perché la prova contraria non è stata scritta, non perché la tesi regga*.

In tre frasi c'è tutto: **il grado A come pavimento, lo spazio vuoto nominato con precisione, la congettura tenuta aperta per onestà e non per convinzione.**

Da qui in avanti il patto è questo. Quando accanto a un'affermazione compare una lettera, **quella lettera si conserva**: nessun capitolo alza un grado che le fonti non alzano, e **la condensazione può far perdere una sfumatura, mai guadagnare una certezza**. Un'assenza è un risultato, con la sede dove cercare. Due tesi restano due, con dichiarato ciò che deciderebbe fra loro. Un nome assolto resta assolto, **senza avversative**. Una coincidenza è censita col suo grado, **non promossa a disegno**. E un'ombra — il caso ne è pieno — è censita, graduata, **con accanto il criterio che potrebbe dissolverla**.

**La scala serve a questo, e a nulla d'altro: a dire, di ogni cosa che il caso Moro ancora chiede, esattamente dove la prova finisce.**
...
**Definizioni operative.** I gradi classificano la **specie della fonte**, non il livello di fiducia. Promozione ammessa solo per rinvenimento di documento di specie superiore; promozione per istruzione **vietata**, anche su richiesta del titolare. Distinzione irriducibile fra **Stato Zero** (sede interrogata, risposta assente) e **cella aperta** (sede nominata, non interrogata); categorie intermedie — «Stato Zero debole», «Stato Zero del perimetro raggiunto» — **respinte dai controlli e cancellate**.

**Risultato ricorrente delle matrici, su tre applicazioni indipendenti.** La maggioranza delle evidenze più discusse ha **diagnosticità nulla**. Ciò che discrimina è ogni volta poco, tecnico e non ancora letto.

**Matrice delle omissioni.** Quattro spiegazioni in scala di pretesa crescente (O1→O4); ciascuna richiede tutto il costo della precedente più un incremento. Le evidenze documentate sono in larga parte **compatibili con l'intera scala** e non la ordinano. Topologia: densità elevata fra i settori istituzionali e criminali, **pressoché nulla** fra ciascuno di essi e l'organizzazione armata, che compare come **nodo isolato**. La tavola non produce, e non può produrre, alcun nome.

**Guasti accertati dell'apparato, con misura.**
1. Registro di chiusura: **80 → 36** celle; 44 differenze riclassificate come menzioni.
2. Contatore delle conferme: scritto a mano in 8 punti, **divergente**; sostituito da generatore con criterio dichiarato.
3. Gradi gonfiati: **A→F** in 4 punti; **B→C** in 1; **F→C** in 1, su richiesta di 8 strumenti indipendenti su 10.
4. Misura dell'autocitazione: 38,4% → **29,3%**; causa, falsi positivi da espressione regolare.
5. Effetto dell'osservatore: 196→197 occorrenze per modifica dell'indice; 0→826 per effetto della campagna che assumeva lo zero.
6. Errore di specie a carico dell'estensore: conclusione tratta sul mondo invece che sull'osservazione; correzione annotata accanto, mai sostitutiva.

**Conclusione del referto.** L'apparato ha funzionato **contro chi l'ha costruito** in sei occasioni misurate. Nessuna delle correzioni è arrivata dall'esterno. Questo è, e resta, **l'unico titolo di credito dell'opera**: non ciò che afferma, ma il numero di volte in cui i propri strumenti l'hanno costretta a ritrattare.
...
*e a volte per una cosa più umile di entrambi:*
*un omonimo.*

*C'è un tipo di errore che nessuna cautela previene,*
*perché non è un errore di ragionamento:*
*è un errore di anagrafe,*
*e l'anagrafe non si deduce. Si apre.*

---

## 19. Il calendario contro l'intersezione: Belgrado e l'Ogaden

Una delle catene più eleganti costruite attorno al caso Moro è geopolitica. Dice, in sostanza: nella primavera del 1978 si stava decidendo l'assetto del Corno d'Africa e la partita europea sui diritti umani; l'Italia di Moro aveva una posizione; via Fani cade in mezzo.

Il corpus l'ha sottoposta a cento blocchi mirati e a un apparato di verificatori. Il risultato è una data.

**La conferenza di Belgrado — il primo incontro di verifica del processo di Helsinki — si chiude il 9 marzo 1978. Sette giorni prima di via Fani.**

L'intersezione fra il calendario della crisi dell'Ogaden, quello di Belgrado e quello dei cinquantacinque giorni **è vuota**. Non «debole»: **vuota**. E i verificatori hanno fatto la sola cosa che dovevano fare: hanno **declassato la conclusione** da F a C, applicando la regola dell'anello più debole al ragionamento di chi la sosteneva — cioè a noi.

Duecentonovantatré correzioni su centocinque blocchi. **2,79 correzioni per blocco.**

Questa è la forma corretta di un esito negativo, e va detto perché sembra deludente e non lo è: **un'intersezione vuota è un'informazione.** Toglie dal campo una spiegazione che sembrava buona, e restituisce alle altre lo spazio che quella occupava indebitamente. Un lavoro che producesse solo risultati positivi non sarebbe un lavoro: sarebbe un catalogo di ciò che si sperava di trovare.

---

## 20. La triangolazione che si scioglie in una geografia

Una seconda catena lunga mette insieme tre nomi che il senso comune associa senza fatica: **Josef Mengele**, **Klaus Barbie**, **Stefano Delle Chiaie**. Tre latitanze, tre continenti attraversati, tre biografie che nella memoria pubblica si sovrappongono per affinità e non per documenti.

Il corpus ha cercato la giuntura, e ha trovato quello che si trova quasi sempre: **una co-presenza geografica scambiata per una struttura.**

Ed è qui che nasce la regola più utile dell'intera opera, che qui si enuncia e nel Libro quinto si mette alla prova:

> **La co-presenza di latitanti in un rifugio è la definizione di rifugio, non l'indizio di un'organizzazione.**

Due uomini nella stessa giurisdizione **non sono una rete**: sono ciò che una giurisdizione produce **quando non estrada**. Aggiungete che le loro condotte di latitanza erano incompatibili — uno viveva da recluso sotto falso nome, evitando ogni contatto; un altro gestiva per telefono una rete su quattro continenti — e la giuntura non solo non è provata: **è tecnicamente improbabile**, perché non è lo stesso mestiere di latitante e non produce gli stessi incontri.

La stessa cautela vale, e con più forza, per la catena che avvicina ordinovisti, avanguardisti ed ex ufficiali del Reich. Le appartenenze esistono e sono documentate; alcuni percorsi si sfiorano; alcune reti di supporto sono accertate. Ma **l'appartenenza a un'organizzazione non è prova di condotta**, e questa regola non si sospende quando l'organizzazione è odiosa. **Anzi: è esattamente lì che serve.** Una regola che valga solo per le persone che ci stanno simpatiche non è una regola: è una preferenza con un vocabolario giuridico.

---

## 21. Un omonimo, e la correzione che ne è seguita

Ora l'errore più istruttivo che chi scrive abbia commesso in questa parte, perché è di una specie che il metodo non prevedeva.

In una ricostruzione compariva il nome **Kennedy**. Chi scrive verificò e riferì che **non risultava alcuna parentela** con la famiglia politica americana.

Era una risposta fondata **sull'assenza**: non avevo trovato una menzione, e ne avevo tratto una negazione. È esattamente il vizio che questo libro imputa agli altri, commesso in casa.

Alla domanda ripetuta — *«ma era un Kennedy della Dinastia o meno?»* — la risposta è stata rifatta in forma **positiva**, che è l'unica forma legittima: non «non ho trovato che lo fosse», ma **chi era, di chi era figlio**. Figlio di **Thomas Kennedy** ed **Evelyn Forbes**. La dinastia politica discende per un'altra linea: **Patrick Kennedy → P. J. Kennedy → Joseph P. Kennedy Sr.** Due alberi, un cognome.

Il grado resta **C** — la fonte è quella che è. Ma cambia specie: **da C negativo a C positivo**, e la differenza è tutta.

> **Un'assenza di menzione non è una negazione.** Chi risponde «non risulta» sta descrivendo il proprio archivio, non il mondo.

È la stessa diagnosi del guasto peggiore registrato nel Libro terzo, e non è una coincidenza: **è l'errore caratteristico di chi lavora su un corpus invece che su una realtà.** Il corpus è la sua stanza. Quando dice «non c'è», dice sempre «non c'è **qui**» — e la parola «qui» va scritta, ogni volta, o diventa una menzogna per omissione.

---

## 22. Il vivaio, e un capitolo che dichiara di non valere

L'ultima catena lunga di quest'opera riguarda ciò che il titolare ha chiamato **il vivaio nero**: i canali di formazione, ospitalità e passaggio dell'estrema destra internazionale, sei lotti di indagine.

Il referto va scritto prima del contenuto, perché è più importante del contenuto.

**Di otto lotti previsti ne sono stati lavorati sei. Nessuno è stato verificato. Zero.** L'apparato di verificatori — sei agenti indipendenti col mandato di declassare — **non ha mai girato**: la campagna è stata interrotta da un limite di risorsa esterna, e otto agenti su quattordici hanno restituito errore, **fra cui tutti e sei i verificatori**.

Le bozze sono state recuperate. Il compilatore ha applicato l'unico controllo che poteva applicare da solo — la qualificazione dei gradi A — e ha registrato **diciassette interventi**. Poi ha scritto in testa al capitolo, prima di ogni riga di contenuto, che **quel capitolo non è verificato**.

**Settantasette blocchi, zero verifiche, e la dichiarazione nella prima riga.**

Questo è, per quest'opera, un capitolo riuscito. Non perché il suo contenuto valga — non vale, e lo dice —, ma perché **un lavoro incompleto che dichiara di esserlo è utilizzabile, e un lavoro incompleto che tace non lo è.** La differenza fra i due non è di qualità: è di **onestà misurabile**, e sta in una riga di testo che chiunque può controllare.

---

## 23. Che cosa hanno in comune tutte le rotture

Cinque catene, cinque punti di rottura diversi:

| catena | si rompe su | strumento che l'ha rotta |
|---|---|---|
| Cohn → Trump → Mosca | 12 sezioni su 21 postume | il calendario |
| Badalamenti → Bonanno → Cohn | i due rami si uccidevano | l'atto giudiziario altrui |
| NCO → Senese → Spada | freccia invertita, 35 anni di scarto | la genealogia e il calendario |
| Belgrado / Ogaden / via Fani | intersezione vuota | il calendario |
| Mengele / Barbie / Delle Chiaie | co-presenza ≠ struttura | la demografia |

E un tratto comune, che è il vero risultato del libro: **nessuna di queste catene è stata rotta trovando una prova contraria.** Sono state rotte **applicando alle loro premesse strumenti che chiunque possiede**: una data, una carta geografica, un censimento, l'atto di un processo che era pubblico da quarant'anni.

**Non serviva un archivio segreto. Serviva aprire un calendario.**

Questo è, insieme, il risultato più tranquillizzante e il più allarmante dell'opera. Tranquillizzante, perché significa che la macchina che fabbrica è **fragile**: cede al primo controllo elementare. Allarmante, perché significa che quel controllo elementare, in mezzo secolo di pubblicistica, **quasi nessuno l'ha fatto**.
...
**Catena geopolitica (Belgrado/Ogaden).** 105 blocchi, 293 correzioni imposte (**2,79 per blocco**). Chiusura della conferenza di Belgrado: **9 marzo 1978**, sette giorni prima di via Fani. **Intersezione dei calendari: vuota.** Conclusione declassata dai verificatori **da F a C** per applicazione della regola dell'anello più debole all'estensore.

**Catena delle latitanze (Mengele/Barbie/Delle Chiaie).** Nessun documento raggiunto collega i tre. Condotte di latitanza reciprocamente incompatibili. Frattura: **co-presenza geografica scambiata per struttura**. Regola derivata: *la co-presenza di latitanti in un rifugio è la definizione di rifugio.*

**Catena delle appartenenze (ordinovisti, avanguardisti, ex ufficiali del Reich).** Appartenenze documentate; condotte non trasmesse. Applicazione integrale e non selettiva della regola: **l'appartenenza a un'organizzazione non è prova di condotta**, anche e specialmente per le organizzazioni odiose.

**Correzione di specie a carico dell'estensore (omonimia Kennedy).** Prima risposta fondata sull'assenza di menzione; rifatta in forma positiva — figlio di **Thomas Kennedy** ed **Evelyn Forbes**; la linea dinastica discende **Patrick → P. J. → Joseph P. Sr.** Grado invariato (**C**), specie mutata: da **C negativo** a **C positivo**. Regola derivata: *chi risponde «non risulta» descrive il proprio archivio, non il mondo.*

**Campagna del vivaio nero.** 6 lotti su 8 lavorati; **77 blocchi; verifiche: zero**; 8 agenti su 14 in errore, **inclusi tutti i verificatori**; 17 qualificazioni di grado applicate dal solo compilatore. **Non verificato, e dichiarato tale nella prima riga del capitolo.** Ripresa possibile per riassunzione della campagna dalla cache; i sei elaborati esistenti replicano senza costo, e restano da eseguire i verificatori e i lotti 7 e 8.

**Conclusione del referto.** Cinque fratture, cinque strumenti, **nessuna prova contraria**. Tutte le rotture sono state ottenute con strumenti di dominio pubblico — calendari, atlanti, dati demografici, atti processuali pubblicati. Ne segue la sola tesi generale che questo referto autorizza: **la fragilità di queste catene non è stata scoperta; è stata soltanto verificata, in ritardo di decenni.**
...
*Dispone — e questo si ferma alla frontiera,*
*come l'acqua si ferma dove finisce il pendio.*

*Chi confonde le due cose crede all'impunità.*
*Chi le distingue vede una cosa più semplice e più fredda:*
*non un uomo che sfugge,*
*ma due Stati che non si parlano.*

---

## 24. Quattro paesi, un solo enunciato

Il caso Moro e i suoi dintorni hanno prodotto un piccolo campionario di latitanze che nessun disegno unitario spiega e che una sola regola spiega tutta.

**Alessio Casimirri.** Componente accertato del commando di via Fani, sei ergastoli pronunciati **in contumacia**; latitante in **Nicaragua** dal 1982; l'unico componente identificato del commando **mai arrestato**. Le richieste di estradizione sono state respinte. Il giudicato lo riguarda per intero — la contumacia non attenua la definitività — ma la pena non è mai stata eseguita.

**Alvaro Lojacono.** Responsabilità accertata per l'intero arco 16 marzo – 9 maggio, definitiva in Cassazione il **14 maggio 1997**. La **Svizzera** non estrada i propri cittadini.

**La Francia**, per una stagione, con la cosiddetta dottrina Mitterrand.

**Il Brasile**, che è il caso su cui la regola si lascia misurare meglio, e a cui si dedica il resto di questo libro.

L'enunciato che li tiene insieme è di una brevità quasi offensiva:

> **Nessuno dei quattro dice nulla sulle persone: dicono tutto sugli Stati.**

---

## 25. Tre uomini, tre decenni, un paese
...
Una catena si scrive da sola, e infatti è stata scritta molte volte.

**E fra i tre non risulta alcun legame.** Non negli atti, non nelle fonti raggiunte, non nel corpus, dove la ricerca di prossimità fra i loro nomi dà **zero**.

---

## 26. Perché non ne segue nulla, in tre strati

**Primo: non c'è un documento.** Nessuna fonte raggiunta collega i tre uomini fra loro. La sola co-presenza accertabile è quella fra Mengele e Badalamenti nello stesso Stato brasiliano, per circa un anno.
...
**Terzo, ed è quello che chiude: lo Stato di San Paolo aveva, nel 1979, oltre venti milioni di abitanti.**

*Erano in tre paesi diversi che si chiamavano tutti Brasile:*
*la reclusione di un uomo che si era cancellato,*
*la San Paolo di un trafficante che lavorava,*
*il Pernambuco di un commerciante con due figli.*

---

## 27. Lo Stato che non ritarda una pena: la riscrive

È qui che la regola supera se stessa, e diventa qualcosa di più di un'osservazione.
...
**Non è clemenza e non è impunità.** È **diritto costituzionale altrui che tocca un giudicato italiano**, e dice — più forte di prima — tutto sullo Stato e nulla sull'uomo.

Vale la pena fermarsi su questo punto, perché è il più controintuitivo del libro. La narrazione pubblica legge le latitanze come **atti di volontà individuale**: qualcuno *sfugge*, qualcuno *protegge*, qualcuno *copre*. E ogni tanto è vero. Ma la spiegazione strutturale — **una frontiera che non si apre** — copre gli stessi fatti a costo enormemente minore, e va esclusa **prima**, non dopo. Non perché sia più simpatica: perché è più economica, e in ogni ricostruzione seria l'ipotesi che richiede meno va confutata per prima.

**Un rifugio in comune non è una rete: è una frontiera che non si apre.**

---

## 28. Come si prova una regola

Una regola vale se **predice**, non se spiega.

La formula sul rifugio era stata scritta guardando Mengele e Badalamenti. **Scotti è un caso indipendente, ed è venuto dopo**: nessuno lo aveva usato per costruirla, e vi si è applicato senza attriti — anzi, l'ha rafforzata, portando un elemento che la formula originaria non prevedeva (la riscrittura della pena).

**Una previsione che tiene su un caso nuovo vale più di una spiegazione che si adatta a un caso vecchio.**

Ed è la ragione per cui questo libro sta in una monografia sul caso Moro. Non perché il Brasile c'entri con via Fani. Perché **la stessa domanda che questo libro fa al caso italiano — «è un disegno o è una proprietà del sistema?» — qui ha una risposta netta**, e serve da metro.

Sul Brasile la risposta è: **proprietà del sistema.** Non un disegno, non una protezione: una **giurisdizione che non estrada**, e trentasei anni di latitanze che ne sono la conseguenza aritmetica.

Sul caso italiano la risposta non è ancora nota, e questo libro non finge di averla. Ma ora ha un **metro**: sa come è fatta una risposta «proprietà del sistema» quando la si trova davvero, e sa che le prove che la sostengono sono di quel tipo — un'aritmetica, una costituzione straniera, una convenzione bilaterale — e non di quello suggestivo.
...
**Un capitolo assorbito, e va detto.** La narrazione di questo libro riprende per intero il capitolo *«La regola del rifugio: perché le pene si fermano alla frontiera»*, che ne riprende i tre uomini, le date e la commutazione: nell'edizione ridotta esso si legge a sé, qui sarebbe una seconda lettura della stessa pagina. **Non è stato tagliato: è stato assorbito**, e ogni sua data, cifra e nome sta nelle pagine che precedono.
...
**Enunciato di base.** Una sentenza definitiva **accerta** e **dispone**. L'accertamento è irrevocabile ovunque; **la disposizione si ferma alla frontiera.**

**Casi.** Casimirri: sei ergastoli in contumacia, latitanza in Nicaragua dal 1982, estradizioni respinte, unico componente identificato del commando mai arrestato. Lojacono: definitivo in Cassazione 14 maggio 1997; la Svizzera non estrada i propri cittadini. Francia: dottrina Mitterrand. Brasile: v. infra.

**Serie brasiliana.** Mengele †7 febbraio 1979, Bertioga (SP), sepolto come Wolfgang Gerhard, identificato 1985, DNA 1992. Badalamenti, esiliato in Brasile dal 1978, arrestato a Madrid l'8 aprile 1984. Scotti, evaso dall'ospedale civile di Caserta nella notte di Natale 1984, catturato a Recife il 26 maggio 2015 dopo **11.110 giorni**. Intervallo Badalamenti-Scotti: **260 giorni**. Copertura complessiva: **circa trentasei anni quasi continui**.

**Ricerca di legami.** **Zero** occorrenze di prossimità nelle fonti raggiunte e nel corpus. Condotte di latitanza reciprocamente incompatibili (reclusione totale vs. operatività transcontinentale). Base demografica: Stato di San Paolo, oltre venti milioni di abitanti nel 1979.

**Accertamento dirimente.** Estradizione Scotti, **10 marzo 2016**: ergastolo **commutato in trent'anni** quale condizione della consegna, per non riconoscimento del «fine pena mai» nell'ordinamento brasiliano. **Lo Stato ospite ha modificato la misura di un giudicato italiano come prezzo del consenso.**

**Conclusione del referto.** La regola formulata su due casi ha retto su un terzo, indipendente e successivo, **aggiungendo un elemento non previsto**. Vale dunque come regola e non come spiegazione *ad hoc*. Enunciato finale: **la co-presenza di latitanti in un rifugio è la definizione di rifugio, non l'indizio di un'organizzazione; un rifugio in comune non è una rete, è una frontiera che non si apre.** Nessuna persona è, in questo referto, indicata come responsabile di alcun fatto oltre quanto già accertato dai rispettivi giudicati.
...
*e l'unica che dica qualcosa di vero su chi la scrive.*

*Perché una ricerca che non dichiari i propri limiti li nasconde,*
*e chi li nasconde li trasforma in conclusioni.*
*È così che nasce quasi tutto il falso di questo caso:*
*non da una bugia,*
*ma da un silenzio con l'aria del risultato.*

---

## 29. Il risultato più severo, e va detto per primo

Il corpus si era dato una condizione di chiusura: **ogni cella aperta deve portare una data di interrogazione**. Non una risposta: una **data**. Il segno che qualcuno è andato a bussare.

Le celle aperte con sede sono state prese una per una e interrogate, per quanto si poteva. Sono **trentatré**.

**Tre chiuse. Trenta non interrogabili. Stati Zero nuovi: zero.**
...
Ne segue una cosa che quest'opera deve sapere di sé, e dirla in prima persona: **da questa postazione non può produrre un solo accertamento negativo nuovo.** Può soltanto convertire celle in **consegne** — cioè in indicazioni di sede, per qualcuno che possa andarci.

Le consegne registrate sono **trenta**, e si dividono esattamente a metà: **quindici aperture immediate** — sedi che una connessione di rete raggiungerebbe, e che questa non raggiunge — e **quindici consegne istituzionali**, cioè richieste che vanno fatte da una persona a un'istituzione, con un nome, una lettera, un appuntamento.

Fra queste ultime: l'archivio di un istituto di ricerca a Roma; un fondo manoscritto in una biblioteca pubblica di New York; un archivio tecnico di ente nazionale; un documento parlamentare identificato per sigla e numero; quattro bobine di microfilm federali conservate in un'università americana.

**Nessuna di esse è segreta. Tutte hanno un indirizzo.**

---

## 30. Lo Stato Zero che riguarda lo strumento, non l'oggetto

Va detto perché cambia la lettura di ogni pagina precedente.
...
**Dalla postazione in cui questo libro è stato generato, quasi nessuna è raggiungibile.** Ogni tentativo di connessione riceve un rifiuto identico e immediato — **un diniego di rete deciso da chi amministra il sistema, non un guasto dei siti**. È stato provato ripetutamente, da controlli diversi, su decine di domini: archivi parlamentari, corti, biblioteche, e perfino gli indirizzi di prova che servono a verificare che una connessione funzioni.
...
E cambia tutto ciò che si è letto finora. **Quando in queste pagine si legge che una sede «non è stata raggiunta», il lettore deve sapere se fosse chiusa al mondo o soltanto a questa macchina. Quasi sempre è la seconda.**

Il tentativo di accedere a un archivio privato romano — quello di un ricercatore che sul caso Moro ha lavorato per decenni — è l'esempio esatto. Si è bussato come si doveva: tre domini, due strumenti diversi, i dinieghi annotati con l'ora. La ricerca ha restituito la **descrizione** di un fondo, e in quella descrizione compariva l'indicazione di atti giudiziari di grande rilievo. Il corpus li ha registrati **come cella**, non come argomento.

**È la distinzione che regge l'intero libro: sapere che un documento esiste non è averlo letto. Un URL citato non è un URL letto.**

---

## 31. La cella che potrebbe ancora decidere: la sabbia

Fra tutte le celle aperte ce n'è una che, sola, avrebbe la forza di spostare il caso. Ed è la più piccola.

**La sabbia trovata sugli abiti di Aldo Moro.**

**La perizia madre.** Nel 1978 una perizia geologico-botanica giudicò la sabbia rinvenuta **nel risvolto sinistro dei pantaloni e sulle scarpe** esclusiva del **litorale tirrenico laziale**, con localizzazione nell'area **Focene–Marina di Palidoro**. *Grado B.* Il lavoro fu imponente: **centocinquanta chilometri di litorale analizzati, novantadue campioni di confronto, riduzione finale a undici chilometri**; e il deposito accomunava **abiti, suole, ruote della Renault e telo**.

**Il rilancio.** La seconda Commissione parlamentare Moro rilanciò gli accertamenti sulle tracce materiali, con l'intervento del RIS negli anni **2016-2017**. *Grado B.*

**Ciò che nessuno dei due ha stabilito: *quando* quel deposito si formò.** Dal perimetro raggiunto da questa ricerca, **non risulta che alcuno abbia mai datato il deposito**: le relazioni tecniche del 2016 riguardano principalmente la Renault 4 e i residui di sparo.

**La domanda non è mai stata posta.** Ed è tutto.

Perché il deposito può essersi formato in **tre finestre**, e le conseguenze sono opposte fra loro.

**Prima del 16 marzo 1978** — l'uomo indossava i propri abiti e la sabbia vi era già. **L'evidenza si cancella**: diagnosticità zero, e **una delle tesi più diffuse sul caso perde il proprio unico appoggio materiale**.

**Fra il 16 marzo e il 9 maggio**, durante la custodia. **L'evidenza diventa decisiva**: le ipotesi di custodia unica ne escono gravemente urtate. **È il solo esito che sposterebbe qualcosa dal terreno del certo a quello del discusso.**

**Dopo il 9 maggio**, nel trasporto del corpo. L'evidenza **si cancella** quanto alla custodia e diventa un dato sulla logistica finale.
...
E c'è una **precondizione**, che nella pratica viene quasi sempre saltata. **Un inventario pubblico unitario dei reperti minori del caso non esiste**, e la catena di custodia integrale — sequestro, perizie, trasferimenti, sedi — va ricostruita dagli atti.
...
La prima domanda è dunque quella della **riesaminabilità**: quali reperti degli abiti e delle calzature sono oggi conservati, in quale sede, in quale stato; quali campionature storiche esistono e sono ancora utilizzabili; quali interventi conservativi o analitici hanno subito dal 1978 a oggi.

**Se la risposta è negativa, il quesito finisce qui** — e l'esito negativo va scritto con la sede nominata, perché sarebbe **esso stesso un'acquisizione**: chiuderebbe la cella dichiarandola **non riempibile**.

Il quesito centrale, poi, è uno solo: **la stratigrafia**. Il deposito è unico o multiplo? Si distinguono strati? Mostrano rapporti di sovrapposizione con altri materiali repertati — terre, bitumi, fibre, residui urbani? **Un deposito sabbioso *sotto* un residuo attribuibile all'ambiente della custodia colloca la sabbia nella prima finestra; *sopra*, nella seconda.**

*Quarantotto anni di ipotesi,*
*e la cosa che le ordinerebbe tutte*
*sta in un risvolto di pantaloni,*
*e chiede una domanda che nessuno ha scritto.*

---

## 32. Le altre due celle di via Fani

Restano, fuori dagli abiti, le due celle materiali dell'agguato, ed è giusto che il libro le lasci aperte con il loro nome.

**Il caricatore** repertato all'angolo fra via Fani e via Stresa **non fu mai sottoposto a comparazione in quarantotto anni**. Nuovi esami sono stati disposti dal giudice.

**I profili genetici** estratti nel **2016** dai mozziconi repertati nell'auto di sbarramento e nella base di via Gradoli restano, allo stato, **senza attribuzione pubblica**.

Sono, nella tavola del Libro primo, le due celle che potrebbero promuovere o affondare l'unica ipotesi interessante — quella delle presenze estranee **operative**. Non le testimonianze. Non la balistica. **Due reperti, e un esame che non è stato letto.**

**Il rapporto fra ciò che si potrebbe sapere e ciò che si sa è, in via Fani, più squilibrato che in qualunque altro punto del caso. E gli atti per colmarlo sono già stati disposti.**
...
**Un capitolo assorbito, e va detto.** La narrazione di questo libro riprende per intero il capitolo *«Ciò che non si è potuto aprire, e a chi si può chiedere»*, che ne riprende il conto delle celle e la distinzione fra il bussare e il non bussare: nell'edizione ridotta esso si legge a sé, qui sarebbe una seconda lettura della stessa pagina. **Non è stato tagliato: è stato assorbito**, e ogni sua data, cifra e nome sta nelle pagine che precedono.

---

## 31. Il quesito della sabbia: le domande, nell'ordine

*Il Libro settimo ha già dato l'oggetto — la perizia del 1978, le tre finestre, la precondizione della riesaminabilità, il quesito centrale sulla stratigrafia. Questo capitolo non lo ripete: aggiunge le domande residue, nell'ordine in cui vanno poste, e per ciascuna che cosa deciderebbe.*

### La conferma della provenienza

Con granulometria, mineralogia, microfossili e le tecniche oggi disponibili: **la localizzazione del 1978 è confermata, ristretta o rivista?**

Con un limite da dichiarare in perizia, e non in nota: **mezzo secolo cambia le spiagge.** Le campionature attuali di confronto vanno adoperate come termine di paragone ragionato, **non come identità**. Una spiaggia del 2026 non è la spiaggia del 1978 con lo stesso nome: è un altro deposito nello stesso luogo.

*Che cosa deciderebbe.* Una conferma restringe il campo delle vie di deposito. Una revisione lo sposta altrove — e sposterebbe con sé un'intera famiglia di ricostruzioni che sulla localizzazione del 1978 hanno poggiato per quarant'anni senza mai riesaminarla.

### La composizione del deposito, e i suoi compagni

Il deposito accomunava **abiti, suole, ruote della Renault e telo**. La domanda è se i quattro depositi siano **il medesimo deposito** o **quattro depositi compatibili**.

*Che cosa deciderebbe.* Se il deposito sulle suole differisce da quello sul risvolto, i due si sono formati in momenti o luoghi diversi, e la finestra si sdoppia. Se coincidono, la logistica finale li ha uniti — e il dato si sposta dalla custodia al trasporto.

### La stratigrafia dei materiali estranei

Oltre alla sabbia, che cos'altro il tessuto porta: **terre, bitumi, fibre, residui urbani, pollini**. E in quale ordine di deposizione.

*Che cosa deciderebbe.* I pollini hanno un calendario proprio, più fine di quello della sabbia: una specie che fiorisce in una finestra determinata **data il deposito da sé**, se il deposito è primario e non contaminato. È la sola via, fra tutte quelle elencate, che potrebbe restituire **un mese** invece di un intervallo.

### La contaminazione, che va cercata prima e non dopo

Quali interventi conservativi o analitici i reperti hanno subito dal 1978 a oggi; **quali manipolazioni sono documentate e quali no**; quali materiali estranei sono attribuibili alle sedi di conservazione anziché ai fatti.

*Che cosa deciderebbe.* Tutto. **Un deposito attribuito ai fatti che provenga da uno scaffale non è un errore di misura: è un reperto fabbricato dall'archivio.** Ed è la ragione per cui questa domanda, benché ultima nell'elenco, è **la prima da porre**: le quattro che la precedono valgono zero finché non ha risposta.

### L'orologio che era già agli atti

Qui sta il reperto più singolare dell'intera vicenda: **il quesito stagionale ha già un oggetto, e ha quarantotto anni.**

Nel risvolto dei pantaloni la perizia madre — il geologo **Gianni Lombardi** con **Valerio Giacomini** e collaboratori — repertò **un capolino di *Centaurea aspera***, giudicato *«in stadio di sviluppo identico»* alle piante della zona indicata.

**L'orologio stagionale esiste già agli atti dal 1978.** Il quesito moderno deve chiederne **la rilettura, non l'invenzione**: la perizia aveva già repertato, descritto e valutato l'oggetto che porta in sé l'informazione stagionale. **Ciò che manca non è lo strumento — è la domanda.**

### La fonte che potrebbe smentire questo capitolo

E va scritta in chiaro, perché è un esempio di come si tratta una possibile smentita di sé stessi.

La seconda campagna di verifica ha censito uno studio indicizzato su PubMed: **G. Lombardi, *«The contribution of forensic geology… to the investigation of the killing of Aldo Moro»*, *Journal of Forensic Sciences*, 44(3), pp. 634-642, maggio 1999, PMID 10408122.**

**Se il contenuto confermasse quanto il titolo lascia intendere, potrebbe contraddire direttamente l'affermazione secondo cui il deposito non è mai stato datato.** Il grado è **C**, e va spiegato: l'articolo è **indicizzato** — esiste, è citabile, ha un nome, un anno e un identificativo — **ma il suo contenuto non è stato aperto né letto**, perché l'accesso bibliotecario necessario non è stato tentato.

**La cella dunque non si dichiara chiusa: si dichiara la fonte primaria che può chiuderla.** Ed è la prima volta che questa domanda ne ha una con un nome, un anno e un identificativo. **Un lavoro che nascondesse questa fonte per proteggere la propria conclusione non sarebbe un metodo**: la scrive in chiaro, e mette la propria affermazione in attesa di essa.

### Che cosa il quesito non chiede

Perché è qui che le letture in malafede attecchiscono.

**Non chiede di riaprire un processo.** **Non chiede di rimettere in discussione un giudicato**: chiede di misurare quanto quel giudicato sia stretto in un punto che nessuno ha mai misurato — *la conferma è un esito, non un'ovvietà*. **Non chiede un nome**: l'esito migliore è una data, il peggiore una dichiarazione di impossibilità con la sede nominata, **e in nessuno dei due casi ne esce una persona**. E **non chiede di essere creduto**.

Chiede una cosa sola, che è poi ciò che il caso Moro ha ricevuto meno di ogni altra in quarantotto anni: **che si vada a guardare, avendo scritto prima che cosa si sarebbe accettato come smentita.**

**E quattro esiti su sei chiudono la questione contro l'ipotesi forte.** Un esame che potesse soltanto confermare non sarebbe un esame; **e chi lo proponesse sperando in un esito determinato dovrebbe sapere, prima di proporlo, che la probabilità maggiore è che l'esito gli dispiaccia.**

### La regola che il quesito insegna

**Ogni domanda che non concorra a discriminare fra le tre finestre è, per questo scopo, ornamento.** Il quesito della sabbia esiste per mostrare che una domanda utile non è quella che promette la risposta più interessante: **è quella che si può sbagliare.**

**E il criterio di chiusura vale nei due sensi.** Se i reperti non sono riesaminabili, il quesito finisce lì — e **l'esito negativo va scritto con la sede nominata**, perché sarebbe esso stesso un'acquisizione: **chiuderebbe la cella dichiarandola non riempibile.**
...
**Definizioni applicate.** *Stato Zero*: sede interrogata, risposta assente. *Cella aperta*: sede nominata, non interrogata. Categorie intermedie inesistenti. La confusione delle due trasforma **un'ignoranza in un accertamento** ed è il vizio capitale del genere.

**Esito dell'interrogazione sistematica.** Celle interrogate: **33**. Chiuse: **3**. Non interrogabili: **30**. **Stati Zero nuovi: 0.** Nessuna cella si è chiusa come accertamento negativo. Consegne registrate: **30**, ripartite in **15 aperture immediate** (raggiungibili con accesso di rete) e **15 consegne istituzionali** (richiedono una persona, una lettera, un appuntamento).

**Stato Zero sullo strumento.** Diniego di rete uniforme e immediato su decine di domini documentali, incluse le sedi pubbliche e gli indirizzi di prova; documentato dal sistema con ora e ragione. **Unico Stato Zero dell'opera che riguardi lo strumento anziché l'oggetto.** Conseguenza vincolante per il lettore: «sede non raggiunta» in queste pagine significa, quasi sempre, **non raggiunta da questa macchina**, non chiusa al mondo.

**Cella a massima diagnosticità residua — reperto sabbia.** Localizzazione 1978: litorale tirrenico laziale, area Focene–Marina di Palidoro (B); base analitica: 150 km di litorale, 92 campioni, riduzione a 11 km; deposito comune ad abiti, suole, ruote e telo. Rilancio RIS 2016-2017 (B). **Datazione del deposito: mai eseguita, per quanto raggiunto.** Tre finestre alternative, di cui una sola (16.03–09.05.1978) modificherebbe l'ordine delle ipotesi sulla custodia. **Precondizione obbligatoria: ricognizione della riesaminabilità e della catena di custodia; nessun esame la precede.** Quesito dirimente: **stratigrafia e rapporti di sovrapposizione**.

**Celle materiali di via Fani.** Caricatore repertato all'angolo via Fani/via Stresa: **mai comparato in 48 anni**; nuovi esami disposti. Profili genetici 2016 da mozziconi (auto di sbarramento; base di via Gradoli): **senza attribuzione pubblica**.

**Conclusione del referto.** Questa ricerca **non può produrre altri accertamenti negativi**. Può soltanto nominare sedi. Le sedi sono nominate, sono pubbliche, e hanno un indirizzo. **Ciò che resta da fare non richiede un archivio segreto: richiede qualcuno che entri in un archivio aperto.**

---

# Congedo · A un uomo che non risponde

*Non le scriverò una lettera, professore,*
*perché lei di lettere ne ha scritte abbastanza*
*e gliene hanno tolta la firma.*

*È la cosa che questo libro non ha mai smesso di guardare:*
*non che l'abbiano ucciso — quello lo dicono cinque sentenze —*
*ma che, prima di ucciderla, l'abbiano dichiarata assente*
*dalle sue stesse frasi.*

*Un uomo si difende da chi lo accusa.*
*Da chi lo scusa non ha difesa nessuna.*

---

**Questa monografia si chiude con un congedo e non con una conclusione**, perché una conclusione richiederebbe di aver concluso, e i due referti principali di quest'opera dicono l'opposto: che ciò che discrimina è poco, tecnico e non ancora letto, e che da questa postazione non si può leggere.

Resta però qualcosa che si può dire, e che non dipende da nessuna cella.

---

## Che cosa ha stabilito questo libro

**Il pavimento è saldo.** Cinque processi, dal 1983 al 1999, hanno accertato l'ossatura del fatto e **tredici responsabilità personali**. Oltre quelle, nessun nome. Chi voglia sostenere qualcosa di diverso deve portare prove **almeno pari** a quelle su cui quelle sentenze si fondano. Non è una preclusione ideologica: è la regola elementare di ogni sapere che non voglia mentire a se stesso.

**Il pavimento vale nei due sensi.** Un'assoluzione definitiva è giudicato quanto una condanna. Gli assolti restano assolti anche quando la narrazione pubblica «sa» qualcosa che il processo non accertò in tempo. È il costo, accettato in anticipo, di avere uno Stato di diritto anziché un tribunale permanente della memoria. **L'alternativa — la condanna per fama — è peggiore di ogni insoddisfazione.**

**Ciò che si discute da mezzo secolo, tecnicamente, non decide.** L'apparato balistico di via Fani è compatibile con tutte le ipotesi in campo. La maggior parte delle evidenze delle omissioni è compatibile con l'intera scala delle spiegazioni. **Quarantotto anni di polemica hanno discusso di evidenze prive di potere discriminante, in entrambe le direzioni.**

**Le catene lunghe si rompono con strumenti che chiunque possiede.** Un calendario. Un atlante. Un censimento. Un atto processuale pubblicato da quarant'anni. Nessuna delle cinque catene smontate in questo libro è caduta per una prova contraria: sono cadute perché **qualcuno ha finalmente controllato le date**.

**E una regola, provata su un caso indipendente e successivo:** la co-presenza di latitanti in un rifugio è la definizione di rifugio, non l'indizio di un'organizzazione. **Un rifugio in comune non è una rete: è una frontiera che non si apre.**

---

## Che cosa ha stabilito su di sé

Sei guasti, tutti misurati, tutti trovati da controlli interni, tutti annotati **accanto** all'errore e mai al posto suo: un registro che contava ottanta celle e ne aveva trentasei; un contatore scritto a mano che aveva derivato in otto punti; quattro gradi A che erano F; una misura dell'autocitazione sbagliata di nove punti per un difetto di espressione regolare; due effetti dell'osservatore; e una conclusione tratta sul mondo invece che sulla propria osservazione.

**Nessuna di queste correzioni è arrivata da fuori.**

È l'unico titolo di credito che questo lavoro possa vantare, e va detto senza enfasi: **non ciò che afferma, ma il numero di volte in cui i propri strumenti l'hanno costretto a ritrattare.**

---

## Che cosa resta da fare, e non lo farà una macchina

Trenta consegne. Quindici sedi che una connessione aprirebbe. Quindici che richiedono **una persona**: una lettera, un nome, un appuntamento, la pazienza di un pomeriggio in una sala di consultazione.

Una domanda mai scritta, che sta in un risvolto di pantaloni, e che si scrive in tre righe: *il deposito è unico o multiplo; si distinguono strati; quegli strati stanno sopra o sotto i residui attribuibili all'ambiente della custodia.*

Un caricatore mai comparato in quarantott'anni.
...
**E la prima di esse non aspetta nessuna verifica.**

---

## La prima consegna

*Ai familiari di Oreste Leonardi, cinquantadue anni.*
*Di Domenico Ricci, quarantatré.*
*Di Giulio Rivera, ventiquattro.*
*Di Francesco Zizzi, trenta.*
*Di Raffaele Iozzino, venticinque.*

*Questo libro non porta loro nulla che non sapessero.*
*Porta soltanto una constatazione di metodo,*
*e sia detta con la freddezza che merita:*

*in quarantotto anni di ricostruzioni,*
*i cinque uomini della scorta sono stati*
*la variabile che tutte le ipotesi lasciavano fuori,*
*perché nessuna ipotesi ne aveva bisogno.*

*Erano già spiegati. Erano già morti nel primo paragrafo.*
*E una cosa spiegata smette di essere guardata.*

*Non è una colpa di nessuno in particolare.*
*È la macchina che fabbrica, che lavora anche sulla memoria*
*e risparmia sui nomi che non aggiungono niente alla trama.*

*L'unico modo di fermarla, su questo punto,*
*è riscrivere i nomi ogni volta.*
*Non come premessa. Non come omaggio.*
*Come dato.*
...
*Non le metterò in bocca una parola,*
*e questo è tutto quello che questo libro può fare per lei.*

*Le hanno tolto la vita in cinquantacinque giorni*
*e la voce in una perizia,*
*e delle due la seconda è quella che ha continuato a lavorare*
*ogni volta che qualcuno ha citato una sua frase*
*aggiungendo «ma non era davvero lui».*

*Qui non si è aggiunto niente.*
*Le sue lettere restano dove sono,*
*con accanto la perizia che le contestò,*
*e accanto ancora la data di quella perizia,*
*perché il lettore possa fare l'unica cosa*
*che nessuno ha fatto per lei a tempo debito:*
*decidere da sé.*

*Novanta secondi, professore.*
*E quarantotto anni.*
*Il primo numero è chiuso da cinque sentenze.*
*Il secondo è ancora aperto,*
*e non lo chiuderà una teoria:*
*lo chiuderà, se qualcuno andrà a leggerlo,*
*un esame su un risvolto di pantaloni.*

---

> **Nota finale, e non è una formula.** Quest'opera è stata generata da un'intelligenza artificiale. È una **fonte secondaria** e non può, per costruzione, valere più di **C** su nulla che non riporti da un atto. Non si cita da sé come riscontro. Non nomina responsabili fuori dal giudicato. Non ha risolto il caso Moro e non lo pretende. **Ha fatto una cosa sola, e la dichiara: ha messo accanto a ogni affermazione il tipo di documento che servirebbe per crederle — e ha scritto, dove quel documento non c'era, l'indirizzo esatto in cui andarlo a cercare.**
...
*perché una percentuale di verità su un fatto non ripetibile*
*non è una misura imprecisa —*
*non è affatto una misura.*

*Ma la domanda ha un cuore giusto, e va servito.*
*Si può ordinare. Si può dire quale atto rende di più.*
*Si può scrivere la formula, e lasciare che la si attacchi.*
*Quello che segue è questo, e non un millimetro di più.*

---

## Che cosa questo numero è, e che cosa non è

Accanto a ciascuna pista sta una cifra su **scala 0-100**. Va detto subito che cosa misura, perché nella pubblicistica su questo caso le cifre hanno una storia cattiva: percentuali di colpevolezza, «probabilità» attribuite a mandanti mai processati, certezze aritmetiche costruite su congetture.

> **Il numero è un indice di priorità istruttoria. Non è la probabilità che una tesi sia vera. Non è — e va scritto due volte — la probabilità che qualcuno sia colpevole.**

Misura **quanto convenga compiere quell'atto adesso**. Una pista a 89 non è vera all'89 per cento: è l'atto che, eseguito oggi, renderebbe più di ogni altro in termini di sapere acquisito. Una pista a 0,1 non è falsa: è un atto che, allo stato delle carte, non è giustificato compiere.

**E il modello è dichiarato, precisamente perché sia attaccabile.** È una somma pesata di cinque criteri, ciascuno da 0 a 10:

| criterio | che cosa valuta | peso |
|---|---|---:|
| **rendimento atteso** | quanto la risposta sposterebbe la linea del sapere | 30 % |
| **diagnosticità** | se l'atto discrimina fra ipotesi concorrenti | 25 % |
| **fattibilità attuale** | autorità competenti e reperti esistenti | 20 % |
| **urgenza** | deperibilità della fonte | 15 % |
| **indipendenza** | dal comparto già giudicato | 10 % |

**Chi contesti un numero deve contestare un sotto-giudizio o un peso. Non c'è altro dentro, e non c'è nulla di nascosto dietro.**

C'è poi una ragione biografica, interna a quest'opera, per cui le percentuali di verità non compaiono. **Una cifra di probabilità è già stata scritta una volta, in questo lavoro, e ritirata**: dipendeva da un parametro che non era stato dichiarato. La lezione è stata pagata.
...
| 10 | Il registro delle segnalazioni dei cinquantacinque giorni | **61,0** |
...
**La chiave di lettura, che spiega perché le prime sei stanno dove stanno: le prime sei sono verificabili con un atto singolo e datato** — una perizia, un'escussione, un fascicolo, un reperto, una visura. Le ultime dipendono da aperture altrui o da comparazioni lunghe.

E due delle prime **sono già in corso**: la Procura di Roma tiene aperto un procedimento sulle terze presenze di via Fani, e il giudice per le indagini preliminari ha respinto la richiesta di archiviazione disponendo nuove indagini. Su quelle, il lavoro civile si ferma dove comincia il fascicolo penale.
...
**La deposizione mai resa** sta **fuori scala**, non sotto la scala, e la differenza è tecnica: rendimento incerto, valore unico — e un indice che somma criteri non sa dove metterla. Alessio Casimirri è l'unico partecipante identificato di via Fani **mai interrogato da un'autorità italiana**. L'atto che il programma tiene pronto non è l'estradizione: è la **rogatoria conoscitiva** — domande scritte, verbalizzazione in forma utilizzabile, senza consegna, comunque vada. **È, potenzialmente, l'atto istruttorio più ricco rimasto al caso**, e insieme quello dal rendimento meno prevedibile. E il programma mette in conto anche il nulla: *l'esito negativo documentato vale più dell'attesa indefinita.*

**Lo 0,1 non è uno sberleffo.** Non è zero, perché un documento primario nuovo riporterebbe ciascuna di quelle piste in tavola; è 0,1 perché, fino a quel documento, **nessun atto è giustificato**. È il criterio di riapertura scritto come numero: **il modo in cui una pista si archivia senza chiuderla.**

Sulla **seconda prigione**: è accertato al grado **A** che Moro fu detenuto in via Montalcini 8, appartamento acquistato nel giugno 1977 e intestato a persona condannata all'ergastolo — *è il dato che qualunque ipotesi alternativa deve spiegare, e che la maggior parte non spiega.* La riapertura, se verrà, non verrà da una rilettura: **verrà da un'evidenza fisica** — pollini, sabbie, fibre riletti con la scienza attuale — **o da un documento**.

Su **Hyperion** due cose vanno dette con la stessa forza. La genealogia è documentata, ai gradi F e B. E: **tutti i procedimenti aperti su Hyperion e sui suoi fondatori si sono chiusi con proscioglimenti; nessuno è mai stato condannato**, e i fondatori godono per intero della presunzione d'innocenza. Le due tesi che da quarant'anni si contendono il nodo restano entrambe congetture non provate, **e non si sommano: la loro coesistenza quarantennale misura l'assenza di accertamento, non la sua abbondanza.** I nessi operativi sono archiviati per anello debole — ogni cammino da quella genealogia a via Fani passa per **archi biografici**, e un arco biografico non è un arco di condotta. Test di riapertura, uno solo: **un documento primario che trasformi un arco biografico in un arco di condotta.**

---

## E la pista che non c'è

La tavola non contiene una pista sul **mandante**, e l'assenza è deliberata.

L'ipotesi che il sequestro sia stato ordinato o diretto da una potenza o da un servizio straniero è stata investigata per quattro decenni, da tre commissioni parlamentari e da più procure, con gli archivi progressivamente aperti su entrambi i versanti della cortina. **Non ha mai trovato prova.** Le inchieste hanno accertato contesti, attenzioni, contatti, ambienti; **non hanno accertato il mandato.**

Il caso Moro è **povero di collusioni provate e ricco di convergenze non concertate** — interessi che spinsero nella stessa direzione senza accordo. **E una condizione, a differenza di un mandato, non ha autori.**

Che cosa manca perché la parola «mandante» diventi scrivibile è dichiarato: **un documento — verbale, direttiva, rendiconto operativo — che attesti un'iniziativa non dichiarata diretta a impedire l'accordo politico con mezzi eccedenti quelli diplomatici.** Gli archivi non sono esauriti, e quel falsificatore è concretamente concepibile: è, fra gli Stati Zero maggiori, quello che l'apertura di nuovi fondi potrebbe più verosimilmente rovesciare.

**Ma finché quel documento non esiste, nessuna pista lo presuppone.**
...
*Le definizioni stanno per esteso nel Prologo — la scala Savona e il suo sdoppiamento — e nel Libro terzo — i gradi, le matrici, gli Stati Zero. Qui stanno soltanto in forma di richiamo rapido, per chi cerchi una voce e non un capitolo.*

### I gradi

| grado | che cosa significa |
|:-:|---|
| **A** | **giudicato definitivo**; e, come esito di ricerca, la sola proposizione su un accertamento negativo di rango |
| **B** | **accertamento** di un organo che accerta: commissioni d'inchiesta, atti istruttori, testimonianze qualificate. *Nessun effetto penale* |
| **C** | **congettura**: l'ipotesi che spiega e non prova |
| **F** | **fatto pubblico**: circostanza biografica o notoria che non attribuisce nulla a nessuno |
| **Stato Zero** | **assenza documentata**: ho bussato alla sede, l'ho interrogata, la risposta non c'è |
| **cella aperta** | la sede esiste, la nomino, **non ci ho bussato** |

**I gradi classificano la specie della fonte, non il livello di fiducia.** Un grado **non si alza decidendolo: si alza trovando il documento della specie superiore.**

### I tetti delle fonti

Atti giudiziari **A** · atti parlamentari **B** · documenti desecretati **B** · atti normativi e comunitari **A/F** · memorialistica **C** salvo riscontri · pubblicistica **C**, mai fonte di accertamento.

### Le regole che non si negoziano

**La responsabilità è personale** (art. 27 Cost.): nessuno è indicato come responsabile fuori da un giudicato definitivo. **L'appartenenza a un'organizzazione non è prova di condotta.** **Gli assolti restano assolti, i prosciolti restano prosciolti** — la formula «fu assolto, ma…» è bandita. **Le divergenze si riportano, non si scelgono.** **Le correzioni si annotano accanto, mai in silenzio.**

### I corollari che si perdono più spesso

**La convergenza non si promuove a nesso.** **La contemporaneità non è nesso.** **La parentela non è canale.** **Il doppio sospetto non è un grado di prova.** **I buchi documentali si misurano, non si riempiono.** **Il grado di una catena è il grado del suo anello più debole; la tenuta di una catena è la tenuta della sua giuntura peggiore.** **Un'attribuzione «non conclusiva» non è un indizio: è assenza di informazione.** **Una fonte non è un fatto, nemmeno quando confessa.** **Un URL citato non è un URL letto.**

### Come si leggono le matrici

Si elencano **ipotesi mutuamente esclusive** che coprano il campo; si elencano le evidenze coi loro gradi; per ogni incrocio: **compatibile, incompatibile, neutro** — o il punto interrogativo della cella non letta. Poi **le evidenze compatibili con tutte le ipotesi si cancellano**, perché non discriminano.

**Si contano le incompatibilità, non le conferme.** **Un'evidenza compatibile con un'ipotesi non la conferma.** **Un'ipotesi che non paga prezzi non guadagna nulla dal non pagarli.**

### Le quattro specie di legame fra mondi

**Collusione** — l'accordo provato. **Infiltrazione.** **Transito informativo.** **Convergenza** — interessi che spingono nella stessa direzione senza accordo. *Una condizione, a differenza di un mandato, non ha autori.*

### Che cosa questo metodo non fa

**Non produce colpevoli.** Non assegna percentuali di verità né quote di colpa. Non scioglie divergenze peritali. Non usa lo stupore come prova. **Non chiude una cella senza l'atto che la chiuderebbe — e non la lascia aperta senza nominare la sede.**

---

## Nota sulla verifica

Ogni capitolo documentario di quest'opera è stato confrontato **riga per riga** con i documenti sorgente da **un verificatore indipendente**, col mandato di **tagliare ogni fatto non presente nelle fonti, ripristinare ogni grado alterato e riaprire ogni divergenza risolta di nascosto**.

**Gli interventi imposti furono centoventidue**, e si distribuiscono così:

| classe di intervento | numero |
|---|---:|
| **tagli di fatti non presenti nelle fonti** | **51** |
| correzioni puntuali di formulazione, cifra o attribuzione | **40** |
| **gradi e qualificatori ripristinati** | **13** |
| conservazioni verificate conformi e dichiarate | **10** |
| **divergenze riaperte** che il capitolo aveva appiattito | **8** |

**La classe più numerosa è la prima, e dice qual è il vizio caratteristico di questa scrittura**: non l'invenzione di fatti, ma **l'espansione retorica di fatti veri** — la glossa che rende una data più eloquente di quanto la fonte la faccia, l'aggettivo che qualifica ciò che la fonte lascia nudo, la chiosa che spiega ciò che la fonte si limita a registrare. Il verificatore le ha tagliate a decine, e ogni taglio porta scritta accanto la ragione: *«non presente nella fonte»*.

**La seconda lezione sta nella terza classe.** Tredici volte un grado o un qualificatore erano stati **omessi o attenuati** — un «attribuito al Livello B» diventato un'attribuzione secca; un «nel perimetro degli atti raggiunti» diventato «negli atti dei cinque procedimenti»; una clausola d'eccezione dichiarata dalla fonte **risolta di nascosto** in una formula generica. **Nessuna di queste alterazioni aggiungeva un fatto falso: ciascuna rendeva un fatto vero più forte di quanto fosse.** È esattamente la deriva che i gradi esistono per impedire, e la si è trovata **dentro il testo che li dichiara**.

**E la quarta classe è la più istruttiva.** Otto volte una divergenza che la fonte riportava — due letture, due cifre, un dissenso interno non risolto — era stata **appiattita** dal capitolo in un enunciato unico. **Appiattire una divergenza non è sintetizzare: è decidere al posto delle fonti, e tacerlo.** Le otto sono state riaperte.

---

**Il registro integrale dei centoventidue interventi, voce per voce, con il capitolo, il passo e la ragione di ciascuno, si legge nell'edizione ridotta.** Non è riprodotto qui **per una ragione che va detta invece di essere taciuta**: quel registro indicizza i capitoli **con la numerazione dell'edizione ridotta**, e quest'opera li ha riordinati in sette libri, assorbendone quattro nella narrazione. **Riprodurlo qui significherebbe stampare centoventidue rinvii a numeri che in questo volume non corrispondono più.**

*Un apparato di verifica che rinviasse a numeri sbagliati sarebbe peggio di un apparato assente: darebbe l'apparenza della verificabilità senza la sostanza.* La sintesi che precede è dunque tutto ciò che questa edizione può dare con esattezza — **e l'edizione in cui il registro si legge per intero, con la numerazione che tiene, è nominata qui accanto**.
