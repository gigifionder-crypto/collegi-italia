...
- **Volumi metodologici** — Volume 0.A (Reference Case, asse Italia),
  Volume 0.B (Reference Case, asse Unione Europea).
- **Sintesi nazionale** — Volume 1 (quadro nazionale, league table
  interregionale).
- **Volumi regionali** — Volumi 2–21, le 20 regioni italiane in ordine
  alfabetico (Puglia inclusa come Volume 14, trattata qui in forma di
  sintesi/cruscotto regionale; la trattazione a piena profondità di Puglia
  resta quella del Tomo I).
- **Volume unionale** — Volume 22, sezione UE-27 (27 schede-Stato +
  simulazione aggregata). Presente anche come collegamento simbolico in
  `../ue-27/`.

Ogni volume regionale segue lo stesso schema: Premessa, Introduzione,
Cruscotto regionale, Sintesi per il decisore, Cinque risultati chiave,
